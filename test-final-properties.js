...
const simulateEditorFlow = () => {
  ...
  return { availableBlocks, getBlockDefinitionForType, generateBlockDefinitions };
};

// Executar teste
const { availableBlocks, getBlockDefinitionForType, generateBlockDefinitions } = simulateEditorFlow();
...
testBlocks.forEach(blockType => {
  ...
  const editableProps = Object.entries(definition.properties).filter(([key, prop]) => 
