...
const componentesImplementados = [
  { nome: 'HeadingBlock', status: '✅ FUNCIONANDO', props: ['level', 'content', 'fontSize', 'textColor', 'textAlign'] },
  { nome: 'TextBlock', status: '✅ FUNCIONANDO', props: ['content', 'fontSize', 'textColor', 'textAlign'] },
  { nome: 'ButtonBlock', status: '✅ FUNCIONANDO', props: ['text', 'link', 'backgroundColor', 'textColor', 'padding'] },
  { nome: 'ImageBlock', status: '✅ FUNCIONANDO', props: ['src', 'alt', 'width', 'height', 'objectFit', 'borderRadius'] },
  { nome: 'SpacerBlock', status: '✅ FUNCIONANDO', props: ['height', 'backgroundColor', 'borderStyle', 'borderColor'] },
  { nome: 'QuizQuestionBlock', status: '✅ FUNCIONANDO', props: ['questionText', 'options', 'layout', 'primaryColor', '...50+ props'] },
  { nome: 'ComponentsSidebar', status: '✅ MELHORADO', props: ['busca', 'categorias', 'filtros', 'feedback visual'] }
];
...
componentesImplementados.forEach((comp, i) => {
  ...
  console.log(`   Props: ${comp.props.slice(0, 3).join(', ')}${comp.props.length > 3 ? '...' : ''}`);
  console.log('');
});
