...
export const FormInputAdvanced: React.FC<FormInputAdvancedProps> = ({
  ...
  const {
    ...
    updateProperty,
    getPropertyByKey
  } = useUnifiedProperties(blockType, blockId, { id: blockId, type: blockType, properties }, onUpdate);
  ...
  const getButtonClasses = () => {
    ...
    const styleClasses = {
      primary: 'bg-[#B89B7A] text-white hover:bg-[#A68B6A] focus:ring-[#B89B7A] disabled:bg-gray-300',
      secondary: 'bg-[#D4C2A8] text-[#432818] hover:bg-[#C4B298] focus:ring-[#D4C2A8] disabled:bg-gray-200',
      outline: 'border-2 border-[#B89B7A] text-[#B89B7A] hover:bg-[#B89B7A] hover:text-white focus:ring-[#B89B7A] disabled:border-gray-300 disabled:text-gray-300',
