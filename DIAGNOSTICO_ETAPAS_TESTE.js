...
function testResilientGet(stepBlocks, step) {
  ...
  console.log(`❌ Nenhum bloco encontrado para etapa ${step}. Chaves disponíveis:`, Object.keys(stepBlocks));
  return [];
}
...
console.log('💡 Dica: Se vir dados vazios, verifique se EditorProvider está inicializando corretamente');
