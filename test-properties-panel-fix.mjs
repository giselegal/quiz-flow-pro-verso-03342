...
const checkPropertiesFixApplied = () => {
  ...
  try {
    ...
    const hasDefaultProperties = editorContent.includes("type: 'string' as const") && 
...
const checkPropertiesPanelStructure = () => {
  ...
  try {
    const panelContent = fs.readFileSync('./src/components/editor/DynamicPropertiesPanel.tsx', 'utf8');
    ...
    const hasInputTypes = panelContent.includes("case 'string'") && 
