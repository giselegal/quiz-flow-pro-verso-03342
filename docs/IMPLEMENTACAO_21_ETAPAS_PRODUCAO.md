...
export interface QuizQuestion { // Interface real (não documentada)
  id: string;
...
export interface QuizOptionReal { // Interface real (não documentada)
  ...
  return [
    ...
    },
    {
      ...
      properties: {
        ...
        options: [/* 8 opções apenas com texto */]
      }
    }
  ];
};
  ...
  return [
    ...
    },
    {
      ...
      properties: {
        ...
        options: [/* 8 opções com URLs corrigidas */]
      }
    }
  ];
};
...
const buttonText = selectedOptions.length === 3 
  ? "Continuar" 
  : `Selecione ${3 - selectedOptions.length} opção(ões)`;
```
