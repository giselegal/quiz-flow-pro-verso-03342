...
export const STEP_CONFIGURATIONS: Record<string, QuestionConfig> = {
  ...
  step07: {
    ...
    options: [
      {
        id: "7a",
        text: "Compra o que precisa, sem complicação",
        value: "7a",
        category: "Natural",
        styleCategory: "Natural",
        points: 1,
      ...
      {
        id: "7b",
        text: "Escolhe peças que durem muito tempo",
        value: "7b",
        category: "Clássico",
        styleCategory: "Clássico",
        points: 1,
      ...
      {
        id: "7c",
        text: "Procura as últimas tendências",
        value: "7c",
        category: "Contemporâneo",
        styleCategory: "Contemporâneo",
        points: 1,
      ...
      {
        id: "7d",
        text: "Investe em peças especiais e únicas",
        value: "7d",
        category: "Elegante",
        styleCategory: "Elegante",
        points: 1,
  ...
  step08: {
    ...
    options: [
      {
        id: "8a",
        text: "Uma bolsa prática e confortável",
        value: "8a",
        category: "Natural",
        styleCategory: "Natural",
        points: 1,
      ...
      {
        id: "8b",
        text: "Um relógio clássico ou pérolas",
        value: "8b",
        category: "Clássico",
        styleCategory: "Clássico",
        points: 1,
  ...
  step09: {
    ...
    options: [
      {
        id: "9a",
        text: "Um espaço aconchegante e descontraído",
        value: "9a",
        category: "Natural",
        styleCategory: "Natural",
        points: 1,
      ...
      {
        id: "9b",
        text: "Um escritório formal e organizado",
        value: "9b",
        category: "Clássico",
        styleCategory: "Clássico",
        points: 1,
      ...
      {
        id: "9c",
        text: "Um ambiente moderno e tecnológico",
        value: "9c",
        category: "Contemporâneo",
        styleCategory: "Contemporâneo",
        points: 1,
      ...
      {
        id: "9d",
        text: "Um espaço luxuoso e exclusivo",
        value: "9d",
        category: "Elegante",
        styleCategory: "Elegante",
        points: 1,
  ...
  step10: {
    ...
    options: [
      {
        id: "10a",
        text: "Simplicidade é o máximo da sofisticação",
        value: "10a",
        category: "Natural",
        styleCategory: "Natural",
        points: 1,
      ...
      {
        id: "10b",
        text: "Elegância nunca sai de moda",
        value: "10b",
        category: "Clássico",
        styleCategory: "Clássico",
        points: 1,
      ...
      {
        id: "10c",
        text: "Estilo é uma forma de expressar quem você é",
        value: "10c",
        category: "Contemporâneo",
        styleCategory: "Contemporâneo",
        points: 1,
      ...
      {
        id: "10d",
        text: "Luxo é uma questão de detalhes",
        value: "10d",
        category: "Elegante",
        styleCategory: "Elegante",
        points: 1,
  ...
  step11: {
    ...
    options: [
      {
        id: "11a",
        text: "São confortáveis e práticos",
        value: "11a",
        category: "Natural",
        styleCategory: "Natural",
        points: 1,
      ...
      {
        id: "11b",
        text: "São elegantes e sofisticados",
        value: "11b",
        category: "Clássico",
        styleCategory: "Clássico",
        points: 1,
      ...
      {
        id: "11c",
        text: "São modernos e inovadores",
        value: "11c",
        category: "Contemporâneo",
        styleCategory: "Contemporâneo",
        points: 1,
  ...
  step13: {
    ...
    options: [
      ...
      {
        id: "13b",
        text: "Preciso de mais variedade",
        value: "13b",
        category: "Dramático",
      ...
      {
        id: "13d",
        text: "Busco peças especiais e únicas",
        value: "13d",
        category: "Elegante",
        styleCategory: "Elegante",
        points: 1,
  ...
  step14: {
    ...
    options: [
      {
        id: "14a",
        text: "Estou pronta para o resultado!",
        value: "14a",
        category: "Final",
        styleCategory: "Final",
        points: 1,
  ...
  step17: {
    ...
    options: [
      {
        id: "17a",
        text: "Ver detalhes do meu estilo",
        value: "17a",
        category: "Resultado",
        styleCategory: "Resultado",
        points: 0,
      },
    ],
    layout: "grid-2",
  ...
  step18: {
    ...
    options: [
      {
        id: "18a",
        text: "Ver guia personalizado",
        value: "18a",
        category: "Detalhes",
        styleCategory: "Detalhes",
        points: 0,
      },
    ],
    layout: "grid-2",
  ...
  step20: {
    ...
    options: [
      {
        id: "20a",
        text: "Quero aproveitar a oferta",
        value: "20a",
        category: "Oferta",
        styleCategory: "Oferta",
        points: 0,
      },
      {
        id: "20b",
