  ...
  try {
    ...
    const componentTypesData = [
      ...
      },
      {
        ...
        default_properties: { content: 'Título', level: 'h2', fontSize: 'text-2xl', fontWeight: 'font-bold' },
        validation_schema: { content: { type: 'string', required: true } }
      },
      {
        ...
        default_properties: { logoUrl: '', logoWidth: 120, progressValue: 0, showBackButton: false },
      ...
      },
      {
        ...
        default_properties: { text: 'Clique aqui', variant: 'primary', backgroundColor: '#B89B7A', textColor: '#ffffff' },
      ...
      },
      {
        ...
        default_properties: { label: 'Campo', placeholder: 'Digite aqui...', required: false, inputType: 'text' },
