...
ANON_KEY="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImluYWJnYmdyZ3pmeGdrYmRhdXNoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTIyNjM1MTcsImV4cCI6MjA2NzgzOTUxN30.RftMKxnqV09nWIVAbJIWMTS-JxiVDOhPZneAXuocGfU"
...
if [ $? -eq 0 ] && [ "$response" != "[]" ] && [ "$response" != "null" ]; then
    ...
    echo "========================================"
    echo "1. Acesse: https://supabase.com/dashboard/project/inabgbgrgzfxgkbdaush"
