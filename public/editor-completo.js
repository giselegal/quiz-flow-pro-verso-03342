    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('div', {
          ...
          // Editor Tools
          modoEdicao && React.createElement('div', {
            key: 'editor-tools',
            ...
            React.createElement('button', {
              ...
              React.createElement('span', { key: 'icon', className: 'text-2xl mb-2' }, '📝'),
              React.createElement('span', { key: 'label', className: 'font-medium text-sm' }, 'Editar Texto')
            ]),
            React.createElement('button', {
              key: 'add-image',
              ...
              React.createElement('span', { key: 'icon', className: 'text-2xl mb-2' }, '🖼️'),
              React.createElement('span', { key: 'label', className: 'font-medium text-sm' }, 'Adicionar Imagem')
            ]),
            React.createElement('button', {
              key: 'edit-options',
              className: 'flex flex-col items-center p-4 border-2 border-dashed border-purple-300 rounded-lg hover:border-purple-400 hover:bg-purple-50 transition-colors'
            }, [
              React.createElement('span', { key: 'icon', className: 'text-2xl mb-2' }, '☑️'),
              React.createElement('span', { key: 'label', className: 'font-medium text-sm' }, 'Opções de Resposta')
            ]),
            React.createElement('button', {
              key: 'style-settings',
              className: 'flex flex-col items-center p-4 border-2 border-dashed border-orange-300 rounded-lg hover:border-orange-400 hover:bg-orange-50 transition-colors'
            }, [
              React.createElement('span', { key: 'icon', className: 'text-2xl mb-2' }, '🎨'),
              React.createElement('span', { key: 'label', className: 'font-medium text-sm' }, 'Personalizar Estilo')
            ])
          ])
        ]))
      ])),
          ...
          React.createElement('div', { key: 'stats' }, [
            ...
            React.createElement('div', {
              ...
              React.createElement('div', {
                ...
                React.createElement('span', { key: 'value', className: 'font-medium' }, '21/21')
              ]),
              React.createElement('div', {
                key: 'stat-questions',
                className: 'flex justify-between text-sm'
                ...
                React.createElement('span', { key: 'value', className: 'font-medium' }, '19')
              ]),
              React.createElement('div', {
                key: 'stat-active',
                className: 'flex justify-between text-sm'
                ...
                React.createElement('span', { key: 'value', className: 'font-medium' }, etapaAtiva)
              ])
            ])
          ]),
