...
const STEPS_CONFIG = [
  ...
  { step: 2, name: "Q1 - Roupa Favorita", description: "Primeira questão sobre estilo de roupa", category: "quiz-question" },
  { step: 3, name: "Q2 - Nome Pessoal", description: "Coleta do nome do usuário", category: "quiz-question" },
  { step: 4, name: "Q3 - Estilo Pessoal", description: "Questão sobre preferências de estilo", category: "quiz-question" },
  { step: 5, name: "Q4 - Ocasiões", description: "Questão sobre ocasiões de uso", category: "quiz-question" },
  { step: 6, name: "Q5 - Cores", description: "Questão sobre preferências de cores", category: "quiz-question" },
  { step: 7, name: "Q6 - Textura", description: "Questão sobre texturas preferidas", category: "quiz-question" },
  { step: 8, name: "Q7 - Silhueta", description: "Questão sobre silhuetas favoritas", category: "quiz-question" },
  { step: 9, name: "Q8 - Acessórios", description: "Questão sobre uso de acessórios", category: "quiz-question" },
  { step: 10, name: "Q9 - Inspiração", description: "Questão sobre fontes de inspiração", category: "quiz-question" },
  { step: 11, name: "Q10 - Conforto", description: "Questão sobre prioridades de conforto", category: "quiz-question" },
  { step: 12, name: "Q11 - Tendências", description: "Questão sobre seguir tendências", category: "quiz-question" },
  { step: 13, name: "Q12 - Investimento", description: "Questão sobre investimento em roupas", category: "quiz-question" },
  { step: 14, name: "Q13 - Personalidade", description: "Questão final sobre personalidade", category: "quiz-question" },
  { step: 15, name: "Transição", description: "Página de transição para resultado", category: "transition" },
  { step: 16, name: "Processamento", description: "Página de carregamento do resultado", category: "processing" },
  ...
  { step: 21, name: "Oferta Final", description: "Apresentação da oferta comercial", category: "offer" }
];
  ...
  if (config.category === "intro") {
    return [
      ...
      },
      {
        ...
        "position": 2,
        "properties": {
          "content": "Um quiz personalizado para descobrir qual estilo combina perfeitamente com você",
          "fontSize": "text-xl",
          "textAlign": "text-center",
          "color": "#6B7280",
          "containerWidth": "full",
