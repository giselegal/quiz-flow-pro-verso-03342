...
try {
  ...
  const step01Content = fs.readFileSync(
    '/workspaces/quiz-quest-challenge-verse/src/components/steps/Step01Template.tsx',
    'utf8'
  );
...
try {
  const registryContent = fs.readFileSync(
    '/workspaces/quiz-quest-challenge-verse/src/config/enhancedBlockRegistry.ts',
    'utf8'
  );
...
try {
  const serviceContent = fs.readFileSync(
    '/workspaces/quiz-quest-challenge-verse/src/services/templateService.ts',
    'utf8'
  );
