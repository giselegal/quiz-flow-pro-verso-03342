...
export function useFunnelLoader(
    ...
    const loadFunnel = useCallback(async (id: string) => {
        ...
        try {
            ...
            const loadedFunnelMeta = await service.getFunnel(id);
    ...
    const createFunnel = useCallback(async (name: string, createOptions: any = {}): Promise<UnifiedFunnelData> => {
        ...
        try {
            ...
            const newFunnelMeta = await service.createFunnel({
                name,
                context,
                userId,
                ...createOptions,
    ...
    const updateFunnel = useCallback(async (updates: any): Promise<UnifiedFunnelData> => {
        ...
        try {
            ...
            const updatedFunnelMeta = await service.updateFunnel(funnelId, updates);
    ...
    const duplicateFunnel = useCallback(async (newName?: string): Promise<UnifiedFunnelData> => {
        ...
        try {
            ...
            const duplicatedFunnelMeta = await service.duplicateFunnel(sourceFunnelId, targetName) as unknown as FunnelMetadata;
    ...
    }, [funnelId, enableEvents, loadFunnel, service]);
