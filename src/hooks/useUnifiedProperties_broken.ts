...
export const useUnifiedProperties = (
  ...
  const generateDefaultProperties = useCallback(
    (blockType: string, currentBlock: UnifiedBlock | null): UnifiedProperty[] => {
      ...
      // 🎯 PROPRIEDADES UNIVERSAIS OBRIGATÓRIAS EM TODOS OS COMPONENTES
      const getUniversalProperties = (): UnifiedProperty[] => [
        ...
        // === 🎯 1. CONTROLES DE MARGENS (OBRIGATÓRIOS) ===
        {
          key: "marginTop",
      ...
      // 🎯 PROPRIEDADES DE TEXTO UNIVERSAIS (para componentes com texto)
      const getTextProperties = (): UnifiedProperty[] => [
        // === 🎯 7. CONFIGURAÇÕES BÁSICAS DE TEXTO ===
        {
          key: "text",
        ...
        // === 🎯 5 & 6. ALINHAMENTO CENTRALIZADO + LARGURA 100% ===
        {
          key: "textAlign",
      ...
      const baseProperties = getUniversalProperties();
      ...
      switch (blockType) {
        case "text-inline":
          return [
            ...
            {
              key: "lineHeight",
              value: currentBlock?.properties?.lineHeight || "1.5",
              type: PropertyType.SELECT,
              label: "Altura da Linha",
              category: PropertyCategory.STYLE,
              options: [
                { value: "1", label: "1.0 - Compacta" },
                { value: "1.2", label: "1.2 - Apertada" },
                { value: "1.5", label: "1.5 - Normal" },
                { value: "1.75", label: "1.75 - Relaxada" },
                { value: "2", label: "2.0 - Espaçosa" },
              ],
            },
            {
              key: "letterSpacing",
              value: currentBlock?.properties?.letterSpacing || "normal",
              type: PropertyType.SELECT,
              label: "Espaçamento entre Letras",
              category: PropertyCategory.STYLE,
              options: [
                { value: "tighter", label: "Mais Apertado" },
                { value: "tight", label: "Apertado" },
                { value: "normal", label: "Normal" },
                { value: "wide", label: "Largo" },
                { value: "wider", label: "Mais Largo" },
              ],
            },
          ];
        ...
        case "quiz-intro-header":
          return [
            ...
            {
              key: "logoWidth",
              value: currentBlock?.properties?.logoWidth ?? 120,
              type: PropertyType.RANGE,
            ...
            {
              key: "logoHeight",
              value: currentBlock?.properties?.logoHeight ?? 120,
              type: PropertyType.RANGE,
            ...
            {
              key: "title",
              value: currentBlock?.properties?.title || "Título do Quiz",
              type: PropertyType.TEXT,
            ...
            {
              key: "subtitle",
              value: currentBlock?.properties?.subtitle || "Subtítulo",
              type: PropertyType.TEXT,
              label: "Subtítulo",
              category: PropertyCategory.CONTENT,
            },
            {
              key: "description",
              value: currentBlock?.properties?.description || "Descrição do quiz",
              type: PropertyType.TEXTAREA,
              label: "Descrição",
              category: PropertyCategory.CONTENT,
              rows: 3,
        ...
        case "image-display-inline":
          return [
            ...
            {
              key: "src",
              value: currentBlock?.properties?.src || "https://res.cloudinary.com/dqljyf76t/image/upload/v1745071344/GUIA_NATURAL_fzp6fc.webp",
              type: PropertyType.TEXT,
              label: "URL da Imagem",
              category: PropertyCategory.CONTENT,
              required: true,
            ...
            {
              key: "shadow",
              value: currentBlock?.properties?.shadow ?? true,
              type: PropertyType.SWITCH,
              label: "Sombra",
              category: PropertyCategory.STYLE,
            },
            {
              key: "hoverEffect",
              value: currentBlock?.properties?.hoverEffect ?? true,
              type: PropertyType.SWITCH,
            ...
            {
              key: "lazyLoading",
              value: currentBlock?.properties?.lazyLoading ?? true,
              type: PropertyType.SWITCH,
