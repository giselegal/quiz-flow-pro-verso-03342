/**
 * QUESTÕES ORIGINAIS DO QUIZ COM IMAGENS CORRETAS
 * Baseado no arquivo attached_assets com o fluxo completo
 */

export const CORRECT_QUIZ_QUESTIONS = [
  // QUESTÃO 1: QUAL O SEU TIPO DE ROUPA FAVORITA?
  {
    id: "q1",
    title: "QUAL O SEU TIPO DE ROUPA FAVORITA?",
    type: "both" as const, // texto + imagem
    multiSelect: 3,
    options: [
      {
        id: "1a",
    ...
    options: [
      {
        ...
        imageUrl:
          "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735418/39_wlkzbo.webp",
        styleCategory: "Natural",
        points: 1,
      },
      {
