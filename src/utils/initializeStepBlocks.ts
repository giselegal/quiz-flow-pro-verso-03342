...
export const SECTION_TO_BLOCK_TYPE_MAP: Record<string, string[]> = {
  ...
  'cta': ['button-inline'],
  'transition-hero': ['loading-animation', 'heading-inline', 'text-inline', 'progress-indicator'],
  'strategic-question-hero': ['text-inline', 'heading-inline', 'options-grid', 'text-inline'],
