...
vi.mock('@/contexts/editor/EditorStateProvider', () => ({ useEditorState: () => ({ currentStep: 1, selectBlock: () => {}, getStepBlocks: () => [], dirtySteps: {}, setCurrentStep: () => {}, addBlock: () => {}, removeBlock: () => {}, reorderBlocks: () => {}, updateBlock: () => {}, getStepBlocks: () => [], setStepBlocks: () => {}, setSelectedBlock: () => {} }) }));
