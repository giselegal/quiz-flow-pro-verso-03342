...
export const blocksRegistry: Record<string, BlockDefinition> = process.env.NODE_ENV === 'test' ? minimalRegistry : {
    ...
    'sales-hero': {
        ...
        propsSchema: [
            prop({ key: 'eyebrow', kind: 'text', label: 'Eyebrow', category: 'content', default: 'Apresente sua grande ideia' }),
            prop({ key: 'title', kind: 'text', label: 'Título', category: 'content', default: 'Título de impacto que comunica valor', required: true }),
            prop({ key: 'subtitle', kind: 'textarea', label: 'Subtítulo', category: 'content', default: 'Subtítulo claro mostrando benefício e removendo objeções' }),
            prop({ key: 'primaryCtaText', kind: 'text', label: 'CTA Primária', category: 'content', default: 'Começar agora' }),
            prop({ key: 'primaryCtaUrl', kind: 'url', label: 'URL CTA Primária', category: 'content', default: '#' }),
            prop({ key: 'secondaryCtaText', kind: 'text', label: 'CTA Secundária', category: 'content', default: 'Ver detalhes' }),
            prop({ key: 'secondaryCtaUrl', kind: 'url', label: 'URL CTA Secundária', category: 'content', default: '#' }),
            select('align', 'Alinhamento', [
                { value: 'left', label: 'Esquerda' },
                { value: 'center', label: 'Centro' },
                { value: 'right', label: 'Direita' },
            ], { default: 'center' }),
            prop({ key: 'bgColor', kind: 'color', label: 'Cor de Fundo', category: 'style', default: '#FFFFFF' }),
            prop({ key: 'textColor', kind: 'color', label: 'Cor do Texto', category: 'style', default: '#432818' }),
            prop({ key: 'accentColor', kind: 'color', label: 'Cor de Destaque (CTA)', category: 'style', default: '#B89B7A' }),
            select('containerWidth', 'Largura do Container', [
                { value: 'sm', label: 'Pequeno' },
                { value: 'md', label: 'Médio' },
                { value: 'lg', label: 'Grande' },
                { value: 'xl', label: 'Extra' },
                { value: 'full', label: 'Total' },
            ], { default: 'xl', category: 'layout' }),
            prop({ key: 'paddingY', kind: 'range', label: 'Padding Vertical', category: 'layout', min: 0, max: 160, step: 4, unit: 'px', default: 32 }),
        ],
    },
    'form-container': {
        type: 'form-container',
