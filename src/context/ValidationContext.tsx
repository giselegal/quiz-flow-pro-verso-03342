...
interface ValidationContextType {
  validateField: (fieldId: string, value: unknown, validations: ValidationProps[]) => ValidationResult;
...
export function ValidationProvider({ children }: { children: React.ReactNode }) {
  ...
  const validateField = useCallback((fieldId: string, value: unknown, validations: ValidationProps[]): ValidationResult => {
