...
export class EnhancedTemplateMigrator {
  ...
  static async runFullMigration(): Promise<void> {
    ...
    const exampleTemplate = EnhancedTemplateGenerator.generateQuestionTemplate(
      ...
      [
        { id: "2a", text: "Conforto, leveza e praticidade no vestir.", styleCategory: "Natural", points: 1 },
        { id: "2b", text: "Discrição, caimento clássico e sobriedade.", styleCategory: "Clássico", points: 2 },
        { id: "2c", text: "Elegância refinada, moderna e sem exageros.", styleCategory: "Elegante", points: 3 },
      ]
    );
