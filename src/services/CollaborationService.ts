  ...
  private async initializeSupabase() {
    try {
      ...
      if (client) {
        ...
        console.log('✅ CollaborationService: Supabase inicializado (config central)');
      } else {
        console.log('📝 CollaborationService: Modo offline - supabase/config retornou null');
      }
    } catch (error) {
      console.warn('⚠️ CollaborationService: Erro ao obter Supabase central:', error);
    }
  }
