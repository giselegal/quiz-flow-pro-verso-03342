    ...
    const handleAuth = async (e: FormEvent) => {
        ...
        try {
            if (mode === 'signup') {
                ...
                // ========================================================================
                <div className="min-h-screen flex items-center justify-center bg-neon-space relative p-4">
                    <div className="absolute inset-0 bg-hero-soft" />
                    <div className="w-full max-w-md relative z-10">
                        {/* Card de Autenticação */}
                        <div className="rounded-2xl p-8 border-translucent shadow-soft bg-gradient-to-tr from-[#0f1724]/70 to-[#020617]/90 backdrop-blur-xl">
                // ========================================================================
                            ...
                            <h1 className="text-3xl font-bold text-white mb-2 font-title">
                                    ...
                                    <p className="text-sm text-slate-300">
                                        ...
                                        /**
                                         * AuthPage - Página de Autenticação (tema neon-escuro)
                                         */
...
const AuthPage: React.FC = () => {
    ...
    const handleAuth = async (e: FormEvent) => {
            ...
            if (mode === 'signup') {
                                            appLogger.info('Tentando criar nova conta', { email });
                                        await signUp(email, password, {created_via: 'quiz_flow_pro', onboarding_completed: false });
                                        toast.success('Conta criada! Verifique seu email para confirmar.', {duration: 5000 });
                                        setLocation('/admin');
            } else {
                                            appLogger.info('Tentando fazer login', { email });
