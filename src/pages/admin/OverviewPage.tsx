      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border-0 shadow-lg overflow-hidden">
          ...
          <CardContent className="space-y-4 p-6">
            ...
            <div className="pt-2">
              <Button variant="outline" className="w-full border-slate-300 hover:border-indigo-300 hover:bg-indigo-50">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Seus quizzes de estilo pessoal estão <strong>38% acima</strong> da média do setor. 
                      Continue investindo nesta categoria para maximizar ROI.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/50 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-slate-800 mb-1">Oportunidade de Crescimento</div>
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Identificamos <strong>2.3k usuários</strong> que não completaram o quiz. 
                      Uma campanha de remarketing pode recuperar até 25% destes leads.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <Card className="border-0 shadow-lg overflow-hidden">
          ...
          <CardContent className="p-6">
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full justify-start border-slate-300 hover:border-emerald-300 hover:bg-emerald-50">
                <BarChart3 className="h-4 w-4 mr-2" />
                Relatório Detalhado
              </Button>
              
              <Button variant="outline" className="w-full justify-start border-slate-300 hover:border-blue-300 hover:bg-blue-50">
                <Share className="h-4 w-4 mr-2" />
                Compartilhar Dashboard
              </Button>
              
              <Button variant="outline" className="w-full justify-start border-slate-300 hover:border-amber-300 hover:bg-amber-50">
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200/50 rounded-xl">
              <div className="text-center">
                ...
                <Button size="sm" className="mt-3 w-full bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-xs">
                  Upgrade Now
                </Button>
              </div>
            </div>
