      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <Badge
              variant="secondary"
              className="bg-gradient-to-r from-[#B89B7A]/10 to-[#aa6b5d]/10 text-[#432818] border-0"
            >
        ...
        <div className="flex items-center gap-3">
          <Button
            variant="outline"
            className="border-[#B89B7A] text-[#432818] hover:border-[#aa6b5d] hover:bg-[#B89B7A]/5"
          >
        ...
        >
          ...
          <CardContent>
            ...
            <div className="flex items-center text-sm">
              ...
              <span className="ml-1" style={{ color: "#6B4F43" }}>
                vs mês anterior
              </span>
            </div>
            <div className="mt-3">
          ...
          <CardHeader style={{ backgroundColor: "#FAF9F7", borderBottom: "1px solid #E5DDD5" }}>
            <CardTitle className="flex items-center gap-2" style={{ color: "#432818" }}>
              ...
              <Badge
                ...
                style={{ backgroundColor: "#F3E8E6", color: "#432818" }}
              >
                Tempo Real
              </Badge>
            </CardTitle>
