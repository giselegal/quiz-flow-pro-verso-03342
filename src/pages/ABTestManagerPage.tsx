...
const ABTestManagerPage: React.FC = () => {
  ...
  const [selectedTabId, setSelectedTabId] = useState<"active" | "archived">(
    "active"
  );
  ...
  const handleAddVariation = () => {
    if (editedTest) {
      ...
      const updatedVariationsWithPercentages = updatedVariations.map(
        (variation, index) => {
  ...
  const handleDuplicateVariation = (variationId: string) => {
    if (editedTest) {
      const variationToDuplicate = editedTest.variations.find(
        (v) => v.id === variationId
      );
          ...
          <Card className="mb-4">
            <CardContent className="p-4">
              ...
              <Tabs
                ...
                value={selectedTabId}
                onValueChange={(value) =>
                  setSelectedTabId(value as "active" | "archived")
                }
                className="w-full"
              >
              ...
              {filteredTests.length === 0 ? (
                <div className="text-center py-4 text-muted-foreground">
                  Nenhum teste{" "}
                  {selectedTabId === "active" ? "ativo" : "arquivado"}{" "}
                  encontrado.
                </div>
              ) : (
                      ...
                      <div className="space-y-4">
                        {editedTest?.variations.map((variation) => (
                          <Card key={variation.id} className="p-4 border">
                            ...
                            <div className="mt-4">
                              <Label>
                                URL de Checkout (para variação de teste)
                              </Label>
                              <Input
                                value={
                            ...
                            <div className="mt-4">
                              <Label>
                                Informações de Preço (para variação de teste)
                              </Label>
                            ...
                            <div className="flex justify-end mt-4 space-x-2">
                              <Button
                                ...
                                variant="outline"
                                onClick={() =>
                                  handleDuplicateVariation(variation.id)
                                }
                              >
                              ...
                              <div>
                                ...
                                <div className="flex items-center mt-1 text-sm text-muted-foreground">
                                  <div className="flex items-center mr-4">
                                    ...
                                    <span>
                                      {variation.trafficPercentage || 0}% do
                                      tráfego
                                    </span>
                                  </div>
