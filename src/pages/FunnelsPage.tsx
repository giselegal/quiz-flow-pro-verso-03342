    ...
    <div style={{ backgroundColor: '#FAF9F7' }}>
      <div className="max-w-6xl mx-auto p-6">
        <div className="flex justify-between items-center mb-8">
          <h1 style={{ color: '#432818' }} className="text-3xl font-bold">Meus Funis</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              <h2 style={{ color: '#6B4F43' }} className="text-xl font-semibold mb-4">Nenhum funil encontrado</h2>
              <p style={{ color: '#6B4F43' }} className="mb-6">Comece criando seu primeiro funil de conversão</p>
              ...
              {funnels.map((funnel) => (
                <div key={funnel.id} className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  ...
                  <p className="text-sm mb-4" style={{ color: '#6B4F43' }}>
                    Criado em {funnel.created_at ? new Date(funnel.created_at).toLocaleDateString('pt-BR') : 'Data não disponível'}
                  </p>
