  ...
  return (
    <div className="p-4">
      <h1 className="text-xl font-bold mb-4">
        Demonstração de Otimização de Imagens
      </h1>
      ...
      <div className="flex flex-col space-y-8">
        ...
        <section>
          ...
          <p className="text-sm text-gray-600 mb-4">
            Esta seção usa o componente EnhancedAutoFixedImages para corrigir
            automaticamente imagens borradas, com detecção inteligente do LCP e
            escopo limitado.
          </p>
      ...
      <div className="mt-8 p-4 border-t border-gray-200">
        ...
        <p className="text-sm text-gray-600">
          O componente EnhancedAutoFixedImages detecta precisamente quando o LCP
          ocorre, e otimiza as imagens de forma adaptativa às características do
          dispositivo, como densidade de pixels e capacidade de processamento.
          Isso resulta em imagens mais nítidas, sem sobrecarregar dispositivos
          de baixo desempenho.
        </p>
      </div>
    </div>
