    ...
    return (
      <div style={{ borderColor: "#E5DDD5" }}>
        <h2 className="text-red-800 font-bold">
          ❌ ERRO: Bloco de opções não encontrado!
        </h2>
        <p style={{ color: "#432818" }}>
          Template Step02 não contém bloco options-grid
        </p>
  ...
  return (
    <div className="p-8 space-y-6">
      <div style={{ backgroundColor: "#FAF9F7" }}>
        <h2 className="text-blue-800 font-bold mb-2">
          🔍 DEBUG: Dados do Bloco
        </h2>
        <div className="text-sm space-y-2">
          ...
          <p>
            <strong>Número de opções:</strong>{" "}
            {optionsBlock.properties?.options?.length || 0}
          </p>
          <p>
