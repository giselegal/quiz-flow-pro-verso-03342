...
import { ChevronLeft, ChevronRight, Star, Clock, Award, TrendingUp, Users, MessageCircle } from 'lucide-react';
...
const TestimonialSlider: React.FC<{
  ...
  testimonials = [
    { id: '1', name: 'Maria Silva', avatar: '', rating: 5, text: 'Transformou completamente meu guarda-roupa!', role: 'Empresária' },
    { id: '2', name: 'Ana Costa', avatar: '', rating: 5, text: 'Finalmente descobri meu estilo verdadeiro.', role: 'Designer' },
    { id: '3', name: 'Julia Santos', avatar: '', rating: 5, text: 'Recomendo para todas as minhas amigas!', role: 'Advogada' }
  ],
  autoPlay = true,
  interval = 5000 
}) => {
...
const PricingCard: React.FC<{
  ...
  return (
    <div className={`relative bg-white rounded-xl shadow-2xl overflow-hidden ${isPopular ? 'border-2 border-[#B89B7A]' : 'border border-gray-200'}`}>
      {isPopular && (
      ...
      <div className={`p-8 ${isPopular ? 'pt-16' : ''}`}>
        <div className="text-center mb-6">
          <h3 className="text-2xl font-bold text-[#432818] mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>
            {title}
          </h3>
...
export { TestimonialSlider, CountdownTimer, PricingCard, InteractiveProgressBar, SocialProofBanner };
