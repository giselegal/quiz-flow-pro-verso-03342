...
const EnhancedPricingSection: React.FC<EnhancedPricingSectionProps> = ({ className = '' }) => {
  ...
  const handleCTAClick = (e: React.MouseEvent) => {
    ...
    const url = 'https://pay.hotmart.com/W98977034C?checkoutMode=10&bid=1744967466912';
    ...
    schedule('enhanced-pricing:cta-reset', () => {
  ...
  return (
    <div className={`my-16 ${className}`}>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          {/* Badge de Oferta Limitada (estático) */}
          ...
          {/* Elementos Decorativos (radiais) */}
          <div
            className="absolute top-0 left-0 w-32 h-32 opacity-5 pointer-events-none"
            style={{ background: `radial-gradient(circle, ${tokens.colors.primary} 0%, transparent 70%)` }}
          />
          <div
            className="absolute bottom-0 right-0 w-40 h-40 opacity-5 pointer-events-none"
            style={{ background: `radial-gradient(circle, ${tokens.colors.secondary} 0%, transparent 70%)` }}
          />
          ...
          <div className="relative z-10">
            ...
            <div
              ...
              style={{ backgroundColor: tokens.colors.backgroundLight, borderColor: tokens.colors.borderLight }}
            >
              <div className="text-center mb-8">
                <h3 className="text-2xl md:text-3xl font-bold mb-4 text-[#432818]">Tudo que Você Vai Receber</h3>
                <p className="text-[#8F7A6A]">Um pacote completo para sua transformação de imagem</p>
              </div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div
                    key={index}
                    className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-white rounded-lg border border-[#B89B7A]/10 shadow-sm transition-transform duration-200 hover:scale-[1.02]"
                  >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-1">
                          ...
                          <span
                            ...
                            style={{ backgroundColor: product.badge === 'PRINCIPAL' ? tokens.colors.primary : tokens.colors.secondary }}
                          >
                            {product.badge}
                          </span>
                        </div>
                    ...
                    <div className="mt-3 md:mt-0 md:ml-4">
                      <span className="text-lg font-bold" style={{ color: tokens.colors.secondary }}>
                        {product.value}
                      </span>
                    </div>
                  </div>
                ...
                {/* Total */}
                <div className="border-t-2 pt-6 mt-8" style={{ borderColor: tokens.colors.border }}>
                  <div className="flex justify-between items-center text-xl md:text-2xl">
                    ...
                    <div className="relative">
                      <span className="text-3xl font-bold line-through opacity-60" style={{ color: tokens.colors.textMuted }}>
                        R$ 175,00
                      </span>
                    </div>
                  </div>
            ...
            <div className="text-center mb-8">
              ...
              <div className="flex justify-center mb-6">
                <div style={{ backgroundColor: tokens.colors.backgroundAccent }} className="rounded-full p-1">
                  {[
                    ...
                    <button
                      ...
                      className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                        activeTab === tab.key ? 'bg-white text-[#432818] shadow-sm' : 'text-[#8F7A6A] hover:text-[#432818]'
                      }`}
                    >
                      {tab.label}
                    </button>
              ...
              {/* Preço Dinâmico (sem animação JS) */}
              {activeTab === 'parcelado' ? (
                <div className="mb-6">
                  <div className="flex items-center justify-center gap-6 mb-4">
                    <div className="text-center">
                      <p style={{ color: '#8B7355' }}>De</p>
                      <p className="text-2xl md:text-3xl line-through" style={{ color: tokens.colors.textMuted }}>
                        R$ 175,00
                      </p>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="flex items-baseline gap-1 justify-center">
                        ...
                        <span className="text-4xl md:text-5xl font-bold" style={{ color: tokens.colors.accent }}>
                          8,83
                        </span>
                      </div>
                ...
                <div className="mb-6">
                  <div className="flex items-baseline gap-1 justify-center">
                    ...
                    <span className="text-5xl md:text-6xl font-bold" style={{ color: tokens.colors.accent }}>
                      39
                    </span>
              ...
              {/* Badge de Economia */}
              <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-white font-bold mb-6" style={{ backgroundColor: tokens.colors.success }}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm mb-8">
              {[
                ...
                <div key={index} className="flex items-center gap-2 text-[#432818] transition-transform hover:scale-105">
