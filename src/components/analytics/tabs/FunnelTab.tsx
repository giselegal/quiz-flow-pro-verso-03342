            ...
            <Card className="border border-border/60">
              ...
              <CardContent className="space-y-1 pt-0 pb-2">
                <div className="flex justify-between items-baseline">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    de {funnelData[1]?.value || 0}
                  </p>
                </div>
                <Progress
                  value={
                    funnelData[3]?.value && funnelData[1]?.value
                      ? (funnelData[3].value / funnelData[1].value) * 100
                      : 0
                  }
            ...
            <Card className="border border-border/60">
              ...
              <CardContent className="space-y-1 pt-0 pb-2">
                <div className="flex justify-between items-baseline">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    de {funnelData[3]?.value || 0}
                  </p>
                </div>
                <Progress
                  value={
                    funnelData[5]?.value && funnelData[3]?.value
                      ? (funnelData[5].value / funnelData[3].value) * 100
                      : 0
                  }
