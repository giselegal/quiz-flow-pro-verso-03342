      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p style={{ color: "#8B7355" }}>
            Gerenciar modo banco/local e migração
          </p>
        </div>
      ...
      {!databaseMode.isEnabled && (
        <div className="mb-6 p-4 bg-[#B89B7A]/10 border border-[#B89B7A]/30 rounded-md">
          ...
          <p className="text-xs text-[#A38A69] mb-3">
            Converta seus templates locais para o sistema de componentes
            reutilizáveis no banco
          </p>
              ...
              Object.keys(stats.componentsByType).length > 0 && (
                <div className="col-span-2">
                  ...
                  <div className="space-y-1">
                    {Object.entries(stats.componentsByType).map(
                      ([type, count]) => (
                        <div
                          key={type}
