  ...
  return (
    <div className="fixed inset-0 bg-[#fffaf7] z-50 flex items-center justify-center p-4">
      <div className="max-w-3xl w-full bg-white p-8 rounded-lg shadow-lg space-y-6">
        ...
        <p className="text-[#3a3a3a]">
          Ah, e lembra do valor que mencionamos? Prepare-se para uma <strong>surpresa</strong>: o
          que você vai receber vale muito mais do que imagina — e vai custar muito menos do que você
          esperava.
        </p>
