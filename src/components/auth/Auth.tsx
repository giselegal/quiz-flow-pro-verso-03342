    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" 
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-20 left-10 w-32 h-32 rounded-full opacity-5 animate-pulse"
               style={{ backgroundColor: '#B89B7A', animationDuration: '4s' }}></div>
          <div className="absolute bottom-20 right-10 w-24 h-24 rounded-full opacity-10"
               style={{ backgroundColor: '#A88B6A', animation: 'float 6s ease-in-out infinite' }}></div>
          <div className="absolute top-1/2 left-5 w-16 h-16 rounded-full opacity-5"
               style={{ backgroundColor: '#8B7355', animation: 'float 8s ease-in-out infinite reverse' }}></div>
        </div>

        <div className="relative max-w-md w-full rounded-2xl shadow-2xl p-8 border-0 backdrop-blur-sm logo-container" 
             style={{ 
        ...
        <div className="text-center mb-8">
          <div className="relative mx-auto w-24 h-24 mb-6">
            ...
            <div className="absolute inset-0 rounded-full animate-pulse" 
                 style={{ backgroundColor: '#B89B7A', opacity: 0.2 }}></div>
            <div className="absolute inset-2 rounded-full animate-ping" 
                 style={{ backgroundColor: '#A88B6A', opacity: 0.3, animationDuration: '3s' }}></div>
            ...
            <div className="relative w-full h-full rounded-full overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-110 hover:rotate-3 shimmer-effect"
                 style={{ 
                   ...
                   background: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(184, 155, 122, 0.05) 100%)'
                 }}>
              ...
              {/* Brilho que se move */}
              <div className="absolute inset-0 rounded-full opacity-0 hover:opacity-100 transition-opacity duration-1000"
                   style={{
                     background: 'conic-gradient(from 0deg, transparent, rgba(255,255,255,0.3), transparent, rgba(255,255,255,0.2), transparent)',
          ...
          <div className="space-y-3">
            ...
            <p className="text-lg font-medium" style={{ color: '#6B4F43' }}>
              Acesse sua conta <span className="font-bold" style={{ color: '#B89B7A' }}>QuizFlow</span>
            </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="email" className="block text-sm font-medium mb-2" style={{ color: '#432818' }}>
              Email
            </label>
            <Input
              id="email"
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium mb-2" style={{ color: '#432818' }}>
              Senha
            </label>
            <Input
              id="password"
        ...
        <div className="mt-8 text-center space-y-6">
          ...
          >
            ...
            <div className="absolute inset-0 rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                 style={{ backgroundColor: '#B89B7A', opacity: 0.1 }}></div>
          </button>
          ...
          <div className="space-y-4 pt-2">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-center space-x-2">
                <div className="w-1 h-1 rounded-full" style={{ backgroundColor: '#B89B7A' }}></div>
            ...
            <div className="pt-4 border-t space-y-2" style={{ borderColor: '#E5DDD5' }}>
              <div className="flex items-center justify-center space-x-1">
                <div className="w-3 h-3 flex items-center justify-center rounded-full text-xs font-bold text-white"
                     style={{ backgroundColor: '#B89B7A' }}>©</div>
                <p className="text-xs" style={{ color: '#6B4F43' }}>
                  2025 Gisele Galvão. Todos os direitos reservados.
                </p>
              </div>
              
              <p className="text-xs leading-relaxed max-w-sm mx-auto" style={{ color: '#8B7355' }}>
              ...
              <div className="flex items-center justify-center space-x-4 text-xs mt-3">
                <a href="#" className="hover:underline transition-colors" style={{ color: '#B89B7A' }}>
                  Termos de Uso
                </a>
                <div className="w-1 h-1 rounded-full" style={{ backgroundColor: '#E5DDD5' }}></div>
                <a href="#" className="hover:underline transition-colors" style={{ color: '#B89B7A' }}>
