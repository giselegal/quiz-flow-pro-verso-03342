      ...
      <div className="text-4xl mb-6">
        ...
        {loadingType === 'dots' && (
          <div className="flex space-x-2">
            ...
            <div className="w-3 h-3 bg-primary rounded-full processing-dots" style={{ animationDelay: '0.2s' }}></div>
            <div className="w-3 h-3 bg-primary rounded-full processing-dots" style={{ animationDelay: '0.4s' }}></div>
          </div>
        )}
        
        {loadingType === 'bars' && (
          <div className="flex space-x-2">
            <div className="w-2 h-6 bg-primary processing-bars" style={{ animationDelay: '0s' }}></div>
            <div className="w-2 h-5 bg-primary processing-bars" style={{ animationDelay: '0.1s' }}></div>
            <div className="w-2 h-4 bg-primary processing-bars" style={{ animationDelay: '0.2s' }}></div>
          </div>
        )}
      </div>
