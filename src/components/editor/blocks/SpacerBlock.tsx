...
export const SpacerBlock: React.FC<SpacerBlockProps> = ({ content, isSelected, onContentChange, onClick }) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="flex items-center justify-center h-full text-gray-400 text-sm">Espaçador ({height})</div>
    </div>
  );
};
