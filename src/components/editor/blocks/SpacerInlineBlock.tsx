...
import { ArrowUpDown, ArrowLeftRight, Maximize2, Minimize2, Move, MoreHorizontal } from 'lucide-react';
    ...
    >
      <div
        className={cn(
          ...
          // Visual feedback
          isSelected && ['bg-blue-50/50', showGuides && 'border-2 border-dashed border-blue-300'],
