    ...
    <div className={cn('py-12 bg-gradient-to-br from-[#fff7f3] to-[#f9f4ef]', className)}>
      <div className="max-w-4xl mx-auto text-center px-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-[#B89B7A]/20 p-8 md:p-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#aa6b5d] mb-6 leading-tight">{mainText}</h2>

          <p className="text-lg text-[#432818] mb-8 max-w-2xl mx-auto leading-relaxed">
            Agora que você descobriu seu estilo predominante, é hora de colocar esse conhecimento em prática. Receba um
            guia personalizado com tudo que precisa para transformar sua imagem.
          </p>
          ...
          {showSecurityBadge && (
            <div className="mt-6 pt-6 border-t border-[#B89B7A]/20">
              <div className="flex items-center justify-center gap-4 text-xs text-[#8F7A6A]">
                <img src="https://static.hotmart.com/img/hotmart-logo.png" alt="Hotmart" className="h-4 opacity-70" />
                <span>•</span>
