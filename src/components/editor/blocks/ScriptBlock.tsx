...
const ScriptBlock: React.FC<BlockComponentProps> = ({
  ...
  return (
    ...
    >
      ...
      <pre className="whitespace-pre-wrap break-all text-gray-200">{code || '// Seu código JavaScript aqui...'}</pre>
      <p className="text-xs text-gray-500 mt-2">Este código será injetado na página publicada.</p>
    </div>
  );
};
