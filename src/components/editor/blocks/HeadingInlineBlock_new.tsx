 ...
 */
const HeadingInlineBlock: React.FC<BlockComponentProps> = ({ block, isSelected = false, onClick, className = '' }) => {
...
export const formatHeadingText = (text: string, username?: string, pattern: string = '{{username}}'): string => {
