  ...
  return (
    ...
    >
      ...
      >
        {/* Icon */}
        {showIcon && (
          <div className={cn('flex-shrink-0 p-2 bg-gray-50 rounded-full', layout === 'vertical' && 'mb-2')}>
            {getIcon()}
          </div>
        )}
        ...
        <div className={cn('flex-1', layout === 'vertical' ? 'text-center' : 'text-left')}>
          {/* Value */}
          <div
            className={cn('font-bold text-gray-800 leading-none', currentSize.value, isAnimating && 'animate-pulse')}
          >
            <InlineEditableText
              value={displayValue}
