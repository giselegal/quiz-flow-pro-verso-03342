            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-[#432818] leading-relaxed">
                  Especialista em consultoria de imagem e estilo pessoal, Gisele Galvão dedica sua carreira a ajudar
                  mulheres a descobrirem e expressarem sua autenticidade através do vestir.
                </p>
              </div>

              {showCredentials && (
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-[#aa6b5d]">Por que confiar na Gisele?</h3>
              ...
              <div className="bg-[#f9f4ef] p-4 rounded-lg border border-[#B89B7A]/10">
                <p className="text-sm text-[#432818] italic">
                  "Minha missão é mostrar para cada mulher que ela já possui tudo o que precisa para ser elegante. Só
                  precisamos despertar essa essência única que existe dentro de você."
                </p>
