// Result Components - Modular components for Step 20 (Results page)
export { default as ResultHeaderInlineBlock } from './ResultHeaderInlineBlock';
export { default as PersonalizedHookInlineBlock } from './PersonalizedHookInlineBlock';
export { default as StyleGuidesVisualInlineBlock } from './StyleGuidesVisualInlineBlock';
