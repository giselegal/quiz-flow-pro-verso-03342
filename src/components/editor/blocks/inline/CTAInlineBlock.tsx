...
const CTAInlineBlock: React.FC<CTAInlineBlockProps> = ({
  ...
  const sizeStyles = {
    sm: { padding: 'p-4', title: 'text-lg', subtitle: 'text-sm', button: 'px-4 py-2 text-sm' },
    md: { padding: 'p-6', title: 'text-xl', subtitle: 'text-base', button: 'px-6 py-3 text-base' },
    lg: { padding: 'p-8', title: 'text-2xl', subtitle: 'text-lg', button: 'px-8 py-4 text-lg' },
    xl: { padding: 'p-10', title: 'text-3xl', subtitle: 'text-xl', button: 'px-10 py-5 text-xl' }
  };
