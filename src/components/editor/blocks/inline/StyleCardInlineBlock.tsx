  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-3 sm:mb-4">
        ...
        {/* Título responsivo */}
        <h3 className={cn('font-bold text-[#432818] mb-1', textSizes[cardSize as keyof typeof textSizes])}>
          {styleName}
        </h3>
      ...
      {showProgress && (
        <div className="mb-3 sm:mb-4">
          <div className="flex justify-between items-center text-xs sm:text-sm text-[#5D4A3A] mb-2">
            ...
            <span className="font-bold text-[#B89B7A] bg-[#B89B7A]/10 px-2 py-1 rounded-full">{percentage}%</span>
          </div>
