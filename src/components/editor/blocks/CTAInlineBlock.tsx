...
import { ArrowRight, ShoppingCart, Zap, Star, Clock, Gift, TrendingUp, Loader2 } from 'lucide-react';
      ...
      >
        ...
        {showPrice && (
          <div className="flex-shrink-0 text-right">
            ...
            {showUrgency && urgencyText && <div className="text-xs text-white/80 mt-1">⏰ {urgencyText}</div>}
          </div>
        )}

        {/* Arrow Icon */}
        <div className={cn('flex-shrink-0 transition-transform duration-300', isHovered && 'translate-x-1')}>
