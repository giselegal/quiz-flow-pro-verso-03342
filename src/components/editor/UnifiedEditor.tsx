...
// Componente de erro memoizado para evitar re-renders
...
// Loading fallback memoizado para evitar re-renders
 ...
 */
export const UnifiedEditor: React.FC<UnifiedEditorProps> = React.memo(({ className = '' }) => {
