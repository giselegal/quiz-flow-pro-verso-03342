...
export const QuizConfigurationPanel: React.FC<QuizConfigurationPanelProps> = ({
  ...
  useEffect(() => {
    ...
    if (
      currentStepIndex >= 0 &&
      currentStepIndex < QUIZ_CONFIGURATION.steps.length
    ) {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Badge
                  variant="secondary"
                  style={{ backgroundColor: "#FAF9F7", color: "#432818" }}
                >
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Select
                    defaultValue={selectedStep.rules?.colunas?.toString()}
                  >
        ...
        return (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant="outline"
                style={{ borderColor: "#aa6b5d", color: "#aa6b5d" }}
              >
                {selectedStep.questions?.length || 0} questões
              </Badge>
            </div>
    ...
    >
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="text-xs" style={{ color: "#6B4F43" }}>
                    • Border Radius:{" "}
                    {QUIZ_CONFIGURATION.design.card.borderRadius}
                  </div>
                  <div className="text-xs" style={{ color: "#6B4F43" }}>
                    • Altura da Barra:{" "}
                    {QUIZ_CONFIGURATION.design.progressBar.height}
                  </div>
                  <div className="text-xs" style={{ color: "#6B4F43" }}>
                    • Animações:{" "}
                    {QUIZ_CONFIGURATION.design.animations.questionTransition}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1">
                  {QUIZ_CONFIGURATION.config.analyticsEvents.map(
                    (event: string) => (
      ...
      {selectedStep && (
        <div className="border-t p-3" style={{ borderColor: "#E5DDD5" }}>
          <div className="text-xs" style={{ color: "#6B4F43" }}>
            Etapa {activeStageId} de {QUIZ_CONFIGURATION.steps.length} •{" "}
            {selectedStep.type}
          </div>
        </div>
      )}
