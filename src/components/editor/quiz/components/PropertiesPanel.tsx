                            ...
                            <div className="p-4 space-y-4 text-xs">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {headerConfig.progressEnabled && (<>
                                        ...
                                        <div className="space-y-1"><span>Cor Barra</span><input type="color" className="w-full h-8 border rounded" value={(headerConfig.barColor || '#ccaa6a').substring(0, 7)} onChange={e => onHeaderConfigChange({ barColor: e.target.value })} /></div>
                                        <div className="space-y-1"><span>Cor Fundo</span><input type="color" className="w-full h-8 border rounded" value={(headerConfig.barBackground || '#E5E7EB').substring(0, 7)} onChange={e => onHeaderConfigChange({ barBackground: e.target.value })} /></div>
                                    </>)}
                                </div>
