...
const ColorPicker: React.FC<{
  ...
  const presetColors = [
    '#B89B7A', '#432818', '#6B4F43', '#FAF9F7', '#E5DDD5', '#FEFEFE',
    '#FF6B6B', '#4ECDC4', '#45B7D1', '#96CEB4', '#FFEAA7', '#DDA0DD',
    '#FF7675', '#00B894', '#0984E3', '#6C5CE7', '#FDCB6E', '#E17055'
  ];
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
            ...
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between">
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Habilitar Cabeçalho</Label>
                  <Switch 
                ...
                <div className="flex items-center justify-between">
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Mostrar Logo</Label>
                  <Switch 
                ...
                <div className="flex items-center justify-between">
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Barra Decorativa</Label>
                  <Switch 
            ...
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs" style={{ color: '#6B4F43' }}>Tamanho</Label>
          ...
          <TabsContent value="logo" className="space-y-4 m-0">
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-3">
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>URL da Logo</Label>
                ...
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Texto Alternativo</Label>
                  <Input 
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs" style={{ color: '#6B4F43' }}>Tamanho da Logo</Label>
                    <Badge variant="outline" className="text-xs">
          ...
          <TabsContent value="style" className="space-y-4 m-0">
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs" style={{ color: '#6B4F43' }}>Espessura</Label>
                    <Badge variant="outline" className="text-xs">
                ...
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Posição</Label>
                  <Select 
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-2">
                    <Button
                      ...
                      className="text-xs"
                      style={{ 
                        backgroundColor: properties.alignment === 'left' ? '#B89B7A' : 'transparent',
                        borderColor: '#B89B7A',
                    ...
                    <Button
                      ...
                      className="text-xs"
                      style={{ 
                        backgroundColor: properties.alignment === 'center' || !properties.alignment ? '#B89B7A' : 'transparent',
                        borderColor: '#B89B7A',
                        color: properties.alignment === 'center' || !properties.alignment ? '#FEFEFE' : '#B89B7A'
                      }}
                    >
                    ...
                    <Button
                      ...
                      className="text-xs"
                      style={{ 
                        backgroundColor: properties.alignment === 'right' ? '#B89B7A' : 'transparent',
                        borderColor: '#B89B7A',
