...
export const QuizHeader: React.FC<QuizHeaderProps> = memo(
  ({ userName, currentStep, totalSteps, scores = {} }) => {
            ...
            <div className="flex items-center gap-4">
              {userName && (
                <div className="flex items-center gap-2 bg-white px-3 py-2 rounded-lg shadow-sm">
                  ...
                  <span className="text-sm font-medium text-gray-800">Olá, {userName}!</span>
                </div>
              )}

              <div className="text-right">
                <div className="text-sm font-semibold text-gray-800">Etapa {currentStep}</div>
                <div className="text-xs text-gray-600">de {totalSteps}</div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-6">
              ...
              {totalScore > 0 && (
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-700">Pontos: {totalScore}</span>
                </div>
              )}
            </div>
