...
export const BasicPropertiesPanel: React.FC<
  EnhancedUniversalPropertiesPanelProps
> = ({ selectedBlock, onUpdateBlock, className = "" }) => {
  if (!selectedBlock) {
    return (
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              const prop =
                selectedBlock.properties?.content !== undefined
                  ? "content"
                  : "text";
        ...
        <div>
          ...
          <select
            value={
              selectedBlock.properties?.textAlign ||
              selectedBlock.properties?.alignment ||
              "left"
            }
            onChange={(e) => {
              const prop =
                selectedBlock.properties?.textAlign !== undefined
                  ? "textAlign"
                  : "alignment";
              handlePropertyChange(prop, e.target.value);
            }}
