...
export const PROPERTY_EDITOR_REGISTRY: PropertyEditorRegistry = {
  ...
  stepNavigation: {
    ...
    properties: [
      ...
      {
        name: 'autoAdvanceOnComplete',
        type: 'boolean',
        label: 'Auto-avançar quando completo',
        required: false,
      },
      {
        name: 'autoAdvanceDelay',
        type: 'number',
        label: 'Delay do Auto-Advance (ms)',
        required: false,
        min: 500,
        max: 5000,
        step: 100,
      ...
      {
        name: 'enableButtonOnlyWhenValid',
        type: 'boolean',
        label: 'Habilitar botão apenas quando válido',
        required: false,
      },
      {
        name: 'showValidationFeedback',
        type: 'boolean',
      ...
      },
      {
        ...
        required: false,
        options: ['border', 'background', 'shadow'],
      },
      {
        name: 'selectedColor',
        type: 'color',
    ...
    editorComponent: 'StepNavigationPropertyEditor',
    category: 'navigation',
  },
};
