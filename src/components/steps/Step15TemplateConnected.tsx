...
interface Step15TemplateProps {
  sessionId: string;
  onNext?: () => void;
}

/**
 * 🎯 STEP 15: Estratégica 4 - Ocasiões Especiais
 * ✅ CONECTADO AOS HOOKS: useQuizLogic.answerStrategicQuestion()
 *
 * Questão estratégica para dados complementares
 */
const Step15TemplateConnected: React.FC<Step15TemplateProps> = ({ sessionId, onNext }) => {
  ...
  const options = [
    {
      id: '15a',
      text: 'Opção A - Configurar baseado no step-15.json',
    ...
    {
      id: '15b',
      text: 'Opção B - Configurar baseado no step-15.json', 
  ...
  return (
    ...
    >
      ...
      <QuizNavigation
        ...
        isLastQuestion={15 === 21}
        currentStep={15}
        totalSteps={21}
        stepName="Estratégica 4 - Ocasiões Especiais"
        showUserInfo={true}
        sessionId={sessionId}
      />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#432818] mb-2">
              ESTRATÉGICA 4 - OCASIÕES ESPECIAIS
            </h1>
            <p className="text-sm text-gray-600">
              Dados Complementares 4 de 7 • Selecione 1 opção
            </p>
          </div>
          ...
          <div className="text-xs text-center text-gray-400 mt-4">
            Step 15 | Type: strategic | SessionId: {sessionId}
          </div>
        </div>
      </div>
    </ConnectedTemplateWrapper>
...
export default Step15TemplateConnected;