...
/**
 * 🎯 STEP 14: Estratégica 3 - Estilo de Vida
 * ✅ CONECTADO AOS HOOKS: useQuizLogic.answerStrategicQuestion()
 *
 * Questão estratégica para dados complementares
 */
const Step14TemplateConnected: React.FC<Step14TemplateProps> = ({ sessionId, onNext }) => {
  ...
  const options = [
    {
      id: '14a',
      text: 'Opção A - Configurar baseado no step-14.json',
    ...
    {
      id: '14b',
      text: 'Opção B - Configurar baseado no step-14.json', 
  ...
  return (
    ...
    >
      ...
      <QuizNavigation
        ...
        isLastQuestion={14 === 21}
        currentStep={14}
        totalSteps={21}
        stepName="Estratégica 3 - Estilo de Vida"
        showUserInfo={true}
        sessionId={sessionId}
      />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#432818] mb-2">
              ESTRATÉGICA 3 - ESTILO DE VIDA
            </h1>
            <p className="text-sm text-gray-600">
              Dados Complementares 3 de 7 • Selecione 1 opção
            </p>
          </div>
          ...
          <div className="text-xs text-center text-gray-400 mt-4">
            Step 14 | Type: strategic | SessionId: {sessionId}
          </div>
        </div>
      </div>
    </ConnectedTemplateWrapper>
...
export default Step14TemplateConnected;