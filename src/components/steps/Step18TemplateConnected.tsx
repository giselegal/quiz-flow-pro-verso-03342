...
/**
 * 🎯 STEP 18: Estratégica 7 - Objetivos Finais
 * ✅ CONECTADO AOS HOOKS: useQuizLogic.answerStrategicQuestion()
 *
 * Questão estratégica para dados complementares
 */
const Step18TemplateConnected: React.FC<Step18TemplateProps> = ({ sessionId, onNext }) => {
  ...
  const options = [
    {
      id: '18a',
      text: 'Opção A - Configurar baseado no step-18.json',
    ...
    {
      id: '18b',
      text: 'Opção B - Configurar baseado no step-18.json', 
  ...
  return (
    ...
    >
      ...
      <QuizNavigation
        ...
        isLastQuestion={18 === 21}
        currentStep={18}
        totalSteps={21}
        stepName="Estratégica 7 - Objetivos Finais"
        showUserInfo={true}
        sessionId={sessionId}
      />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#432818] mb-2">
              ESTRATÉGICA 7 - OBJETIVOS FINAIS
            </h1>
            <p className="text-sm text-gray-600">
              Dados Complementares 7 de 7 • Selecione 1 opção
            </p>
          </div>
          ...
          <div className="text-xs text-center text-gray-400 mt-4">
            Step 18 | Type: strategic | SessionId: {sessionId}
          </div>
        </div>
      </div>
    </ConnectedTemplateWrapper>
...
export default Step18TemplateConnected;