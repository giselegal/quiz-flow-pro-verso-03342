...
/**
 * 🎯 STEP 06: Questão 5 - Qual seu orçamento?
 * ✅ CONECTADO AOS HOOKS: useQuizLogic.answerQuestion()
 *
 * Questão regular do quiz que coleta preferências de estilo
 */
const Step06TemplateConnected: React.FC<Step06TemplateProps> = ({ sessionId, onNext }) => {
  ...
  const options = [
    {
      id: '6a',
      text: 'Opção A - Configurar baseado no step-06.json',
    ...
    {
      id: '6b',
      text: 'Opção B - Configurar baseado no step-06.json', 
  ...
  return (
    ...
    >
      ...
      <QuizNavigation
        ...
        currentStep={6}
        totalSteps={21}
        stepName="Questão 5 - Qual seu orçamento?"
        showUserInfo={true}
        sessionId={sessionId}
      />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#432818] mb-2">
              QUESTÃO 5 - QUAL SEU ORÇAMENTO?
            </h1>
            <p className="text-sm text-gray-600">
              Questão 5 de 10 • Selecione 1 opção
            </p>
          </div>
          ...
          <div className="text-xs text-center text-gray-400 mt-4">
            Step 6 | Type: question | SessionId: {sessionId}
          </div>
        </div>
      </div>
    </ConnectedTemplateWrapper>
...
export default Step06TemplateConnected;