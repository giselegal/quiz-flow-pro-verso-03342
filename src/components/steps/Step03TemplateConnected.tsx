...
/**
 * 🎯 STEP 03: Questão 2 - Qual seu tipo físico?
 * ✅ CONECTADO AOS HOOKS: useQuizLogic.answerQuestion()
 *
 * Questão regular do quiz que coleta preferências de estilo
 */
const Step03TemplateConnected: React.FC<Step03TemplateProps> = ({ sessionId, onNext }) => {
  ...
  const options = [
    {
      id: '3a',
      text: 'Opção A - Configurar baseado no step-03.json',
    ...
    {
      id: '3b',
      text: 'Opção B - Configurar baseado no step-03.json', 
  ...
  return (
    ...
    >
      ...
      <QuizNavigation
        ...
        currentStep={3}
        totalSteps={21}
        stepName="Questão 2 - Qual seu tipo físico?"
        showUserInfo={true}
        sessionId={sessionId}
      />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#432818] mb-2">
              QUESTÃO 2 - QUAL SEU TIPO FÍSICO?
            </h1>
            <p className="text-sm text-gray-600">
              Questão 2 de 10 • Selecione 1 opção
            </p>
          </div>
          ...
          <div className="text-xs text-center text-gray-400 mt-4">
            Step 3 | Type: question | SessionId: {sessionId}
          </div>
        </div>
      </div>
    </ConnectedTemplateWrapper>
...
export default Step03TemplateConnected;