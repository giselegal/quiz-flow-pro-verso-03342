 ...
 * 
 * Template para questão 5: Configurável via painel de propriedades
      ...
      <div className="step-content text-center">
        ...
        <div className="content-area mb-6 p-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
          <p className="text-gray-500 mb-4">
            📝 Conteúdo da Etapa 6 - Configure no painel de propriedades
          </p>
...
export const getStep06Template = () => {export const getStep06Template = () => {
  return [
