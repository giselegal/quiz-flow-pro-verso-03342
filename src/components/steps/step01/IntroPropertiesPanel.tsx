...
const BackgroundColorPicker: React.FC<{
  ...
  const brandColors = [
    'transparent', '#FEFEFE', '#FAF9F7', '#E5DDD5', '#B89B7A', '#6B4F43', '#432818'
  ];
  
  const backgroundPresets = [
    '#FFFFFF', '#F8F9FA', '#F1F3F4', '#E8EAED', '#DADCE0', '#F0F0F0'
  ];

  return (
    <div className="space-y-3">
      <Label className="text-xs font-medium" style={{ color: '#6B4F43' }}>{label}</Label>
      
      <div className="flex items-center gap-2">
        <div 
          className="w-8 h-8 rounded border-2 cursor-pointer"
          style={{ 
            background: value === 'transparent' ? 'repeating-linear-gradient(45deg, #ccc 0, #ccc 2px, transparent 2px, transparent 10px)' : value, 
            borderColor: '#E5DDD5' 
          }}
          onClick={() => {
      ...
      {/* Cores da marca */}
      <div>
        <Label className="text-xs mb-2" style={{ color: '#6B4F43' }}>Cores da Marca</Label>
          ...
          {brandColors.map((color) => (
            <button
              ...
              style={{ 
                ...
                backgroundImage: color === 'transparent' ? 'repeating-linear-gradient(45deg, #ccc 0, #ccc 2px, transparent 2px, transparent 10px)' : 'none',
                borderColor: '#E5DDD5' 
              }}
      ...
      {/* Presets de fundo */}
      <div>
        <Label className="text-xs mb-2" style={{ color: '#6B4F43' }}>Presets</Label>
...
export const IntroPropertiesPanel: React.FC<IntroPropertiesPanelProps> = ({
  ...
  const introStep = QUIZ_CONFIGURATION.steps.find(step => step.type === 'intro') || QUIZ_CONFIGURATION.steps[0];
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <TabsContent value="content" className="space-y-4 m-0">
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-3">
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Título</Label>
                  <Input 
                ...
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Descrição Superior</Label>
                  <Textarea 
                ...
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Descrição Inferior</Label>
                  <Textarea 
            ...
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-3">
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Label do Input</Label>
                  <Input 
                ...
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Placeholder</Label>
                  <Input 
                ...
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Texto do Botão</Label>
                  <Input 
                ...
                <div className="flex items-center justify-between">
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Campo Obrigatório</Label>
                  <Switch 
                    checked={properties.required !== undefined ? properties.required : introStep.required}
            ...
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-3">
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Texto de Privacidade</Label>
                  <Textarea 
                ...
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>Texto do Footer</Label>
                  <Input 
          ...
          <TabsContent value="image" className="space-y-4 m-0">
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-3">
                <div>
                  <Label className="text-xs" style={{ color: '#6B4F43' }}>URL da Imagem</Label>
                  <div className="flex gap-2 mt-1">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm"
                      style={{ borderColor: QUIZ_CONFIGURATION.design.primaryColor, color: QUIZ_CONFIGURATION.design.primaryColor }}
                    >
                ...
                {(properties.imageIntro || introStep.imageIntro) && (
                  <div className="mt-3 p-2 border rounded" style={{ borderColor: '#E5DDD5' }}>
                    <div className="text-xs mb-2" style={{ color: '#6B4F43' }}>Preview:</div>
                    <img 
            ...
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs" style={{ color: '#6B4F43' }}>Opacidade</Label>
          ...
          <TabsContent value="layout" className="space-y-4 m-0">
            <Card className="border" style={{ borderColor: '#E5DDD5' }}>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs" style={{ color: '#6B4F43' }}>Escala</Label>
                    <Badge variant="outline" className="text-xs">
                ...
                {/* Alinhamento */}
                <div>
                  <Label className="text-xs mb-2" style={{ color: '#6B4F43' }}>Alinhamento</Label>
                  <div className="grid grid-cols-3 gap-2">
                    <Button
                      ...
                      className="text-xs"
                      style={{ 
                        backgroundColor: properties.alignment === 'left' ? QUIZ_CONFIGURATION.design.primaryColor : 'transparent',
                        borderColor: QUIZ_CONFIGURATION.design.primaryColor,
                        color: properties.alignment === 'left' ? '#FEFEFE' : QUIZ_CONFIGURATION.design.primaryColor
                      }}
                    >
                    ...
                    <Button
                      variant={properties.alignment === 'center' || !properties.alignment ? 'default' : 'outline'}
                      size="sm"
                      onClick={() => handlePropertyUpdate('alignment', 'center')}
                      className="text-xs"
                      style={{ 
                        backgroundColor: properties.alignment === 'center' || !properties.alignment ? QUIZ_CONFIGURATION.design.primaryColor : 'transparent',
                        borderColor: QUIZ_CONFIGURATION.design.primaryColor,
                        color: properties.alignment === 'center' || !properties.alignment ? '#FEFEFE' : QUIZ_CONFIGURATION.design.primaryColor
                      }}
                    >
                    ...
                    <Button
                      ...
                      className="text-xs"
                      style={{ 
                        backgroundColor: properties.alignment === 'right' ? QUIZ_CONFIGURATION.design.primaryColor : 'transparent',
                        borderColor: QUIZ_CONFIGURATION.design.primaryColor,
                        color: properties.alignment === 'right' ? '#FEFEFE' : QUIZ_CONFIGURATION.design.primaryColor
                      }}
                    >
