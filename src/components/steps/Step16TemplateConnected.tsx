...
/**
 * 🎯 STEP 16: Estratégica 5 - Investimento
 * ✅ CONECTADO AOS HOOKS: useQuizLogic.answerStrategicQuestion()
 *
 * Questão estratégica para dados complementares
 */
const Step16TemplateConnected: React.FC<Step16TemplateProps> = ({ sessionId, onNext }) => {
  ...
  const options = [
    {
      id: '16a',
      text: 'Opção A - Configurar baseado no step-16.json',
    ...
    {
      id: '16b',
      text: 'Opção B - Configurar baseado no step-16.json', 
  ...
  return (
    ...
    >
      ...
      <QuizNavigation
        ...
        isLastQuestion={16 === 21}
        currentStep={16}
        totalSteps={21}
        stepName="Estratégica 5 - Investimento"
        showUserInfo={true}
        sessionId={sessionId}
      />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#432818] mb-2">
              ESTRATÉGICA 5 - INVESTIMENTO
            </h1>
            <p className="text-sm text-gray-600">
              Dados Complementares 5 de 7 • Selecione 1 opção
            </p>
          </div>
          ...
          <div className="text-xs text-center text-gray-400 mt-4">
            Step 16 | Type: strategic | SessionId: {sessionId}
          </div>
        </div>
      </div>
    </ConnectedTemplateWrapper>
...
export default Step16TemplateConnected;