...
/**
 * 🎯 STEP 11: Questão 10 - Seu objetivo?
 * ✅ CONECTADO AOS HOOKS: useQuizLogic.answerQuestion()
 *
 * Questão regular do quiz que coleta preferências de estilo
 */
const Step11TemplateConnected: React.FC<Step11TemplateProps> = ({ sessionId, onNext }) => {
  ...
  const options = [
    {
      id: '11a',
      text: 'Opção A - Configurar baseado no step-11.json',
    ...
    {
      id: '11b',
      text: 'Opção B - Configurar baseado no step-11.json', 
  ...
  return (
    ...
    >
      ...
      <QuizNavigation
        ...
        isLastQuestion={11 === 21}
        currentStep={11}
        totalSteps={21}
        stepName="Questão 10 - Seu objetivo?"
        showUserInfo={true}
        sessionId={sessionId}
      />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#432818] mb-2">
              QUESTÃO 10 - SEU OBJETIVO?
            </h1>
            <p className="text-sm text-gray-600">
              Questão 10 de 10 • Selecione 1 opção
            </p>
          </div>
          ...
          <div className="text-xs text-center text-gray-400 mt-4">
            Step 11 | Type: question | SessionId: {sessionId}
          </div>
        </div>
      </div>
    </ConnectedTemplateWrapper>
...
export default Step11TemplateConnected;