...
/**
 * 🎯 STEP 07: Questão 6 - Onde você compra?
 * ✅ CONECTADO AOS HOOKS: useQuizLogic.answerQuestion()
 *
 * Questão regular do quiz que coleta preferências de estilo
 */
const Step07TemplateConnected: React.FC<Step07TemplateProps> = ({ sessionId, onNext }) => {
  ...
  const options = [
    {
      id: '7a',
      text: 'Opção A - Configurar baseado no step-07.json',
    ...
    {
      id: '7b',
      text: 'Opção B - Configurar baseado no step-07.json', 
  ...
  return (
    ...
    >
      ...
      <QuizNavigation
        ...
        currentStep={7}
        totalSteps={21}
        stepName="Questão 6 - Onde você compra?"
        showUserInfo={true}
        sessionId={sessionId}
      />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#432818] mb-2">
              QUESTÃO 6 - ONDE VOCÊ COMPRA?
            </h1>
            <p className="text-sm text-gray-600">
              Questão 6 de 10 • Selecione 2 opções
            </p>
          </div>
          ...
          <div className="text-xs text-center text-gray-400 mt-4">
            Step 7 | Type: question | SessionId: {sessionId}
          </div>
        </div>
      </div>
    </ConnectedTemplateWrapper>
...
export default Step07TemplateConnected;