  ...
  return [
    ...
    },
    {
      ...
      properties: {
        ...
        countdownMinutes: 30,
        urgencyMessage:
          'Não perca esta oportunidade única de transformar sua imagem com seu guia personalizado',
    ...
    },
    {
      ...
      properties: {
        ...
        subtitle:
          'Mulheres que aplicaram seu guia de estilo e transformaram completamente sua imagem pessoal e profissional',
    ...
    },
    {
      ...
      properties: {
        ...
        subtitle:
          'Depoimentos reais de mulheres que transformaram sua imagem e autoestima com nosso guia',
        showRatings: true,
        showProfession: true,
    ...
    },
    {
      ...
      properties: {
        ...
        subtitle:
          'Experimente nosso guia por 7 dias completos. Se não ficar completamente satisfeita, devolvemos seu investimento.',
        guaranteeDays: 7,
        showSealImage: true,
    ...
    },
    {
      ...
      properties: {
        ...
        description:
          'O Guia da Gisele Galvão foi criado para mulheres como você — que querem se vestir com autenticidade e transformar sua imagem em ferramenta de poder.',
        originalPrice: 175,
        currentPrice: 39,
        discount: 78,
