// 🔗 CONNECTED STEP 18 TEMPLATE - QUESTÃO ESTRATÉGICA 6: "Qual desses resultados você mais gostaria de alcançar?"
// Sexta questão estratégica - 1 seleção obrigatória - SEM auto-avanço
    ...
    // 🎯 OPÇÕES ESTRATÉGICAS CONECTADAS (DADOS REAIS)
    {
      ...
      properties: {
        ...
        options: (questionData?.options || []).map((option: any) => ({
          ...
          value: option.id,
          category: option.category || 'desired-outcome',
          strategicType: option.strategicType || 'goal-analysis',
...
export const getConnectedStep18Template = () => {
  return ConnectedStep18Template();
};

export default ConnectedStep18Template;
