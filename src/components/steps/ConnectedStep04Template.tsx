// 🔗 CONNECTED STEP 04 TEMPLATE - Questão: "QUAL VISUAL VOCÊ MAIS SE IDENTIFICA?"
// Terceira questão: Visual com imagens - 3 seleções obrigatórias - Auto-avanço
...
export const getConnectedStep04Template = () => {
  return ConnectedStep04Template();
};

export default ConnectedStep04Template;