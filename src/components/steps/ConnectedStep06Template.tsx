// 🔗 CONNECTED STEP 06 TEMPLATE - Questão: "QUAIS ESTAMPAS VOCÊ MAIS SE IDENTIFICA?"
// Quinta questão: Estampas com imagens - 3 seleções obrigatórias - Auto-avanço
...
export const ConnectedStep06Template = () => {
  ...
  return [
    ...
    // 🎯 GRADE DE ESTAMPAS CONECTADA (DADOS REAIS)
    {
      id: 'step06-prints-options',
      type: 'options-grid',
      properties: {
...
export const getConnectedStep06Template = () => {
  return ConnectedStep06Template();
};

export default ConnectedStep06Template;