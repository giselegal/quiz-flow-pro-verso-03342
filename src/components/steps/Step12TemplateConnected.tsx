...
/**
 * 🎯 STEP 12: Estratégica 1 - Perfil Detalhado
 * ✅ CONECTADO AOS HOOKS: useQuizLogic.answerStrategicQuestion()
 *
 * Questão estratégica para dados complementares
 */
const Step12TemplateConnected: React.FC<Step12TemplateProps> = ({ sessionId, onNext }) => {
  ...
  const options = [
    {
      id: '12a',
      text: 'Opção A - Configurar baseado no step-12.json',
    ...
    {
      id: '12b',
      text: 'Opção B - Configurar baseado no step-12.json', 
  ...
  return (
    ...
    >
      ...
      <QuizNavigation
        ...
        isLastQuestion={12 === 21}
        currentStep={12}
        totalSteps={21}
        stepName="Estratégica 1 - Perfil Detalhado"
        showUserInfo={true}
        sessionId={sessionId}
      />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#432818] mb-2">
              ESTRATÉGICA 1 - PERFIL DETALHADO
            </h1>
            <p className="text-sm text-gray-600">
              Dados Complementares 1 de 7 • Selecione 1 opção
            </p>
          </div>
          ...
          <div className="text-xs text-center text-gray-400 mt-4">
            Step 12 | Type: strategic | SessionId: {sessionId}
          </div>
        </div>
      </div>
    </ConnectedTemplateWrapper>
...
export default Step12TemplateConnected;