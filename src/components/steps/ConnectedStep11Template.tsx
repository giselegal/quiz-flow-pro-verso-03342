// 🔗 CONNECTED STEP 11 TEMPLATE - Questão: "VOCÊ ESCOLHE CERTOS TECIDOS, PRINCIPALMENTE PORQUE ELES..."
// Décima questão: Tecidos (texto) - 3 seleções obrigatórias - Auto-avanço
...
export const ConnectedStep11Template = () => {
  ...
  return [
    ...
    // 🎯 OPÇÕES DE TECIDOS CONECTADAS (DADOS REAIS)
    {
...
export const getConnectedStep11Template = () => {
  return ConnectedStep11Template();
};

export default ConnectedStep11Template;
