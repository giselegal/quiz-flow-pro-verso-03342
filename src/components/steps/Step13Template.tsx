...
export const ConnectedStep13Template = () => {
  ...
  const progressValue = Math.round(((quizState.answers.length + quizState.strategicAnswers.length) / 21) * 100);
  ...
  const handleOptionSelect = (optionId: string, category: string) => {
    ...
    quizState.answerStrategicQuestion('strategic-question-13', optionId, category, 'difficulty-challenge');
  ...
  const options = optionsBlock?.properties?.options || [
    { id: 's13a', text: 'Tenho peças, mas não sei como combiná-las', value: 'combinacao', points: 1 },
    { id: 's13b', text: 'Compro por impulso e me arrependo depois', value: 'impulso', points: 2 },
    { id: 's13c', text: 'Minha imagem não reflete quem eu sou', value: 'desalinhamento', points: 3 },
    { id: 's13d', text: 'Perco tempo e acabo usando sempre os mesmos looks', value: 'repeticao', points: 4 }
  ];
