...
export const ConnectedStep16Template = () => {
  ...
  return [
    ...
    // 🎯 TÍTULO DA QUESTÃO ESTRATÉGICA (DADOS REAIS)
    {
      ...
      type: 'text-inline',
      properties: {
        content: questionData?.text || 'Pense no quanto você já gastou com roupas que não usa ou que não representam quem você é...',
        fontSize: 'text-2xl',
    ...
    // 📋 SUBTÍTULO/DESCRIÇÃO
    {
      ...
      type: 'text-inline',
      properties: {
        content: (questionData as any)?.subtitle || 'Você acredita que ter acesso a um material estratégico, direto ao ponto, que te ensina a aplicar seu estilo com clareza, faria diferença?',
        fontSize: 'text-lg',
