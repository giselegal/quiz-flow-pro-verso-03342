...
export const BadgeInlineBlock: React.FC<BadgeInlineBlockProps> = ({
  ...
  const getVariantStyles = () => {
    switch (variant) {
      ...
      case "elegant":
        return {
          background: "linear-gradient(135deg, #432818 0%, #432818 100%)",
          color: "white",
          border: "none",
      ...
      default:
        return {
          backgroundColor: styleProps.backgroundColor || "#432818",
  ...
  return (
    <div
      className={cn(
        containerClass,
        className,
        isSelected && "ring-2 ring-[#432818]/40 ring-offset-2",
        isEmpty && "border-2 border-dashed border-[#432818]/30 rounded p-2"
      )}
    ...
    >
      {isEmpty ? (
        <div className="flex items-center gap-2 text-[#432818]/60 px-2 py-1">
