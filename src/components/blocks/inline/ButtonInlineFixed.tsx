...
const ButtonInlineFixed: React.FC<ButtonInlineFixedProps> = ({
  ...
  useEffect(() => {
    ...
    const handleInputChange = (e: Event) => {
      ...
      if (detail.blockId === watchInputId) {
        ...
        appLogger.info('🔘 [ButtonInlineFixed] Input validado:', {
          data: [{
            blockId: block?.id,
  ...
  useEffect(() => {
    ...
    const handleGridSelectionChange = (e: Event) => {
      ...
      if (gridId === watchGridId) {
        ...
        appLogger.info('🔘 [ButtonInlineFixed] Grid validado:', {
          data: [{
            blockId: block?.id,
            gridId: watchGridId,
            selectedCount,
  ...
  useEffect(() => {
    ...
    appLogger.info('🔘 [ButtonInlineFixed] Estado geral do botão:', {
      data: [{
        blockId: block?.id,
        inputValid,
        gridSelectionValid,
  ...
  const handleClick = (e: React.MouseEvent) => {
    ...
    appLogger.info('✅ [ButtonInlineFixed] Botão clicado:', {
      data: [{
        blockId: block?.id,
        nextStepUrl,
        nextStepId,
