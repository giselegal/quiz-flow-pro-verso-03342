  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-3 sm:mb-4">
        {/* Ícone responsivo */}
        <div className="inline-flex items-center justify-center bg-gradient-to-br from-[#432818] to-[#432818] rounded-full mb-2 sm:mb-3 p-2 sm:p-3">
        ...
        <p className="text-[#432818] text-xs sm:text-sm leading-relaxed">{description}</p>
      </div>

      {/* Progress modular e responsivo */}
      {showProgress && (
        <div className="mb-3 sm:mb-4">
          <div className="flex justify-between items-center text-xs sm:text-sm text-[#432818] mb-2">
            <span className="font-medium">Compatibilidade</span>
            <span className="font-bold text-[#432818] bg-[#432818]/10 px-2 py-1 rounded-full">
              {percentage}%
            </span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-2 sm:h-2.5">
            <div
              className="bg-gradient-to-r from-[#432818] to-[#432818] h-full rounded-full transition-all duration-500"
