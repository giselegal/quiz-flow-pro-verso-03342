...
export const COMPLETE_21_STEPS_CONFIG: QuizTemplateConfig = {
    ...
    "StrategicQuestionGroup": {
      "props": {
        ...
        "rules": {
          ...
          "buttonActivation": { "type": "string", "editable": false, "value": "Ativa após 1 seleção obrigatória, avança apenas com clique manual" },
  ...
  "logic": {
    "selection": {
      "normal": "Etapas normais: botão só ativa após número de seleções obrigatórias; auto avanço após seleção.",
      "strategic": "Etapas estratégicas: botão só ativa após seleção, avanço apenas com clique manual.",
      "customRules": "Usuário pode ativar/desativar regras de avanço, número obrigatório de seleções, ativação automática ou manual."
    },
    "calculation": {
      "method": "Soma ponto por categoria de cada opção marcada em todas as perguntas principais.",
      "resultado": "O estilo com maior pontuação é o predominante. Os demais estilos são exibidos como secundários, se houver empate, o desempate é pela opção clicada primeira.",
