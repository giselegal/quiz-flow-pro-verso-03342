...
export const blockPropertySchemas: Record<string, BlockSchema> = {
  ...
  // 🆕 G24 FIX: Schemas faltantes para completar 14/14 tipos
  'image-gallery': {
    label: 'Galeria de Imagens',
    fields: [
      {
        key: 'images',
        label: 'Lista de Imagens (JSON)',
        type: 'json',
        group: 'content',
        defaultValue: [
          { url: 'https://via.placeholder.com/300', alt: 'Imagem 1' },
          { url: 'https://via.placeholder.com/300', alt: 'Imagem 2' },
        ],
        description: 'Array de objetos {url, alt}',
      },
      {
        key: 'columns',
        label: 'Colunas',
  ...
  'cta-card': {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'textarea',
        group: 'content',
        defaultValue: 'Aproveite esta oferta especial.',
      },
      {
        key: 'buttonText',
  ...
  'share-buttons': {
    ...
    fields: [
      {
        key: 'title',
        label: 'Título para Compartilhar',
        type: 'text',
        group: 'content',
        defaultValue: 'Confira meus resultados!',
        required: true,
      },
      {
        key: 'description',
        label: 'Descrição para Compartilhar',
        type: 'textarea',
        group: 'content',
        defaultValue: 'Descubra qual é o seu estilo!',
      },
      {
        key: 'shareUrl',
        label: 'URL para Compartilhar',
        type: 'text',
        group: 'content',
        defaultValue: '',
        description: 'Deixe vazio para usar URL atual',
      },
      {
        key: 'platforms',
        label: 'Plataformas Ativas (JSON)',
        type: 'json',
        group: 'content',
        defaultValue: ['facebook', 'twitter', 'whatsapp', 'telegram', 'linkedin'],
        description: 'Array de plataformas: facebook, twitter, whatsapp, telegram, linkedin, copy',
      },
      {
        key: 'layout',
        label: 'Layout',
