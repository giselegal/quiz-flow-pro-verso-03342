...
export const styleConfig: StyleConfigMap = {
  ...
  Clássico: {
    image:
      "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/1_wzxvpz.webp",
    description:
      "Você aprecia a elegância e a sofisticação, com peças atemporais que nunca saem de moda.",
  },
  Moderno: {
    image:
      "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/3_zt8qpb.webp",
    description:
      "Você está sempre na vanguarda da moda, com um estilo contemporâneo e inovador.",
  },
  Romântico: {
    image:
      "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/4_hbwgzt.webp",
    description:
      "Você tem uma alma delicada e feminina, com preferência por peças suaves e detalhes encantadores.",
  },
  Criativo: {
    image:
      "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/5_vlvmgm.webp",
    description:
      "Você expressa sua individualidade através da moda, com combinações únicas e artísticas.",
  },
  Dramático: {
    image:
      "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/6_j7vddl.webp",
    description:
