...
export const QUIZ_CONFIGURATION = {
  ...
  steps: [
      ...
      questions: [
        {
          ...
          multiSelect: 3,
          options: [
            { id: "1a", text: "Conforto, leveza e praticidade no vestir.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735329/11_hqmr8l.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Natural" },
            { id: "1b", text: "Discrição, caimento clássico e sobriedade.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735330/12_edlmwf.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Clássico" },
            { id: "1c", text: "Praticidade com um toque de estilo atual.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/4_snhaym.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Contemporâneo" },
            { id: "1d", text: "Elegância refinada, moderna e sem exageros.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735330/14_l2nprc.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Elegante" },
            { id: "1e", text: "Delicadeza em tecidos suaves e fluidos.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/15_xezvcy.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Romântico" },
            { id: "1f", text: "Sensualidade com destaque para o corpo.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735316/16_mpqpew.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Sexy" },
            { id: "1g", text: "Impacto visual com peças estruturadas e assimétricas.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735319/17_m5ogub.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Dramático" },
            { id: "1h", text: "Mix criativo com formas ousadas e originais.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/18_j8ipfb.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Criativo" }
          ]
        },
        {
          id: "2",
          ...
          multiSelect: 3,
          options: [
            { id: "2a", text: "Informal, espontânea, alegre, essencialista.", styleCategory: "Natural" },
        ...
        },
        {
          ...
          multiSelect: 3,
          options: [
            { id: "3a", text: "Visual leve, despojado e natural.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/2_ziffwx.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Natural" },
            { id: "3b", text: "Visual clássico e tradicional.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/3_asaunw.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Clássico" },
            { id: "3c", text: "Visual casual com toque atual.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735329/13_uvbciq.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Contemporâneo" },
            { id: "3d", text: "Visual refinado e imponente.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735317/5_dhrgpf.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Elegante" },
            { id: "3e", text: "Visual romântico, feminino e delicado.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735330/6_gnoxfg.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Romântico" },
            { id: "3f", text: "Visual sensual, com saia justa e decote.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735327/7_ynez1z.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Sexy" },
            { id: "3g", text: "Visual marcante e urbano (jeans + jaqueta).", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735329/8_yqu3hw.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Dramático" },
            { id: "3h", text: "Visual criativo, colorido e ousado.", imageUrl: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744735329/9_x6so6a.webp", imageSize: { width: 256, height: 256 }, styleCategory: "Criativo" }
          ]
        }
      ]
    },
    {
      ...
      description: "Enquanto calculamos seu resultado, responda perguntas estratégicas para personalizar ainda mais sua experiência.",
      progressBar: { show: false },
      animations: { transition: "fade" },
      backgroundImage: "https://res.cloudinary.com/dqljyf76t/image/upload/v1745515076/C%C3%B3pia_de_MOCKUPS_10_-_Copia_bvoccn.webp",
      textColor: "#432818"
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            { id: "strategic-2-2", text: "Tenho muitas roupas, mas sempre sinto que não tenho nada para vestir" },
            { id: "strategic-2-3", text: "Não consigo criar looks diferentes com as peças que tenho" },
    ...
    },
    {
      ...
      description: "Seu resultado está quase pronto! Calculando respostas e preparando seu guia personalizado.",
      progressBar: { show: false },
      animations: { transition: "fade" },
      backgroundImage: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744911668/C%C3%B3pia_de_Passo_5_Pe%C3%A7as_chaves_Documento_A4_lxmekf.webp",
      textColor: "#432818"
    },
    {
      type: "result",
      ...
      bonus: [
        { title: "Peças-chave para seu estilo", image: "https://res.cloudinary.com/dqljyf76t/image/upload/v1744911668/C%C3%B3pia_de_Passo_5_Pe%C3%A7as_chaves_Documento_A4_lxmekf.webp" },
        { title: "Visagismo facial", image: "https://res.cloudinary.com/dqljyf76t/image/upload/v1745515076/C%C3%B3pia_de_MOCKUPS_10_-_Copia_bvoccn.webp" }
      ]
    }
  ],
  logic: {
    selection: {
      normal: "Avança apenas se o mínimo de seleções (multiSelect) for atingido; botão de avançar desativado até lá.",
    ...
    calculation: {
      ...
      resultado: "O estilo com maior pontuação é o predominante. Os demais estilos são exibidos como secundários.",
      estrategicas: "As respostas estratégicas podem influenciar o CTA, bônus e copy do resultado."
    },
    transitions: {
      betweenSteps: "Usa animação fade/scale, preload de imagens da próxima etapa, barra de progresso animada.",
