...
// 🎯 ESQUEMA COMPLETO DO QUIZ (alinhado ao JSON fornecido)
export const FULL_QUIZ_TEMPLATE = {
  meta: {
  ...
  order: ["intro", "questions", "mainTransition", "strategicQuestions", "finalTransition", "result"],
  steps: [
    {
      type: "intro",
      ...
      required: true,
      validation: { minLength: 2, errorMessage: "Digite seu nome para continuar" },
      privacyText:
    ...
    },
    {
      ...
      questions: [
        ...
        // ... Demais perguntas seguindo o mesmo padrão
      ],
    },
    {
      type: "mainTransition",
...
// Helpers para acesso fácil ao esquema
export const getQuizMeta = () => FULL_QUIZ_TEMPLATE.meta;
export const getQuizDesign = () => FULL_QUIZ_TEMPLATE.design;
export const getQuizOrder = () => FULL_QUIZ_TEMPLATE.order;
export const getQuizLogic = () => FULL_QUIZ_TEMPLATE.logic;
export const getQuizConfig = () => FULL_QUIZ_TEMPLATE.config;
