...
export const MODULAR_COMPONENTS: ModularComponent[] = [
  // 🏗️ ESTRUTURAIS
  {
    ...
    icon: '♿',
    properties: {
      target: { type: 'string', editable: true, default: '#quiz-form', description: 'ID do elemento de destino' },
      text: { type: 'string', editable: true, default: 'Pular para o formulário' },
      className: { type: 'string', editable: true, default: 'sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-50' }
    },
  ...
  },
  {
    ...
    icon: '🏛️',
    properties: {
      className: { type: 'string', editable: true, default: 'w-full max-w-xs sm:max-w-md md:max-w-lg px-4 space-y-8 mx-auto' },
      spacing: { type: 'string', editable: true, options: ['small', 'medium', 'large'], default: 'large' }
    },
  ...
  },
  {
    ...
    icon: '📄',
    properties: {
      className: { type: 'string', editable: true, default: 'w-full max-w-xs sm:max-w-md md:max-w-lg px-4 space-y-6 md:space-y-8 mx-auto' }
    },
  ...
  },
  {
    ...
    icon: '🦶',
    properties: {
      content: { type: 'string', editable: true, default: '© {{currentYear}} Gisele Galvão - Todos os direitos reservados' },
      className: { type: 'string', editable: true, default: 'w-full max-w-xs sm:max-w-md md:max-w-lg px-4 mt-auto pt-6 text-center mx-auto' },
  ...
  // 🎨 CONTEÚDO
  {
    ...
    properties: {
      ...
      className: { type: 'string', editable: true, default: 'text-2xl font-bold text-center leading-tight px-2 sm:text-3xl md:text-4xl' },
      highlights: { 
        type: 'array', 
        editable: true, 
        default: [
  ...
  },
  {
    ...
    properties: {
      ...
      className: { type: 'string', editable: true, default: 'text-sm text-center leading-relaxed px-2 sm:text-base text-gray-600' },
      highlights: {
        type: 'array',
        editable: true,
        default: [
          { text: 'Estilo Predominante', className: 'font-semibold text-[#B89B7A]' }
        ]
      }
    },
  ...
  // 🖼️ MÍDIA  
  {
    ...
    icon: '🖼️',
    properties: {
      baseUrl: { type: 'string', editable: true, default: 'https://res.cloudinary.com/der8kogzu/image/upload/' },
      imageId: { type: 'string', editable: true, default: 'v1752430327/LOGO_DA_MARCA_GISELE_l78gin' },
      formats: {
        type: 'object',
        editable: true,
        default: {
      ...
      fetchPriority: { type: 'string', editable: true, options: ['high', 'low', 'auto'], default: 'auto' }
    },
  ...
  },
  {
    ...
    properties: {
      baseUrl: { type: 'string', editable: true, default: 'https://res.cloudinary.com/der8kogzu/image/upload/' },
      imageId: { type: 'string', editable: true, default: 'v1752443943/Gemini_Generated_Image_i5cst6i5cst6i5cs_fpoukb' },
      formats: {
        type: 'object',
        editable: true,
        default: {
    ...
    properties: {
      ...
      className: {
        ...
        default: {
          ...
          enabled: 'bg-[#B89B7A] text-white hover:bg-[#A1835D] hover:shadow-lg transform hover:scale-[1.01]',
  ...
  },
  {
    ...
    icon: '🔒',
    properties: {
      content: { type: 'string', editable: true, default: 'Seu nome é necessário para personalizar sua experiência...' },
      className: { type: 'string', editable: true, default: 'text-xs text-center text-gray-500 pt-1' }
    },
  ...
  // 📐 LAYOUT
  {
    ...
    icon: '🏷️',
    properties: {
      className: { type: 'string', editable: true, default: 'flex flex-col items-center space-y-2' },
      alignment: { type: 'string', editable: true, options: ['left', 'center', 'right'], default: 'center' }
    },
  ...
  },
  {
    ...
    icon: '🖼️',
    properties: {
      className: { type: 'string', editable: true, default: 'mt-2 w-full max-w-xs sm:max-w-md md:max-w-lg mx-auto' }
    },
  ...
  },
  {
    ...
    icon: '🎁',
    properties: {
      className: { type: 'string', editable: true, default: 'w-full overflow-hidden rounded-lg shadow-sm' },
