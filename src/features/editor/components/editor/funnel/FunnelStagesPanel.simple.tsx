  ...
  return (
    <div className="h-full p-4 bg-white border-r border-gray-200">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 mt-1">{stages.length} etapas do funil</p>
      </div>
            ...
            >
              <div>
                ...
                {activeStageId === stage.id && (
                  <div className="text-xs text-brand font-medium mt-1">● Ativa</div>
                )}
              </div>
            </Button>
          ))
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        <div className="text-xs text-gray-500 space-y-1">
          <div>
            Etapa ativa: <strong>{activeStageId}</strong>
          </div>
