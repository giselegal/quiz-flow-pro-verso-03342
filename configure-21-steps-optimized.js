...
const QUIZ_DATA = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'd', text: 'Cores vibrantes e contrastantes', score: { dramatico: 3, contemporaneo: 2 } }
      ]
    },
  ...
  styles: {
    ...
    classico: {
      ...
      guideImage: 'https://res.cloudinary.com/dqljyf76t/image/upload/v1745071344/GUIA_CLASSICO_abc123.webp'
    },
    romantico: {
      name: 'Romântico',
      ...
      guideImage: 'https://res.cloudinary.com/dqljyf76t/image/upload/v1745071344/GUIA_ROMANTICO_def456.webp'
    },
    dramatico: {
      name: 'Dramático',
      ...
      guideImage: 'https://res.cloudinary.com/dqljyf76t/image/upload/v1745071344/GUIA_DRAMATICO_ghi789.webp'
    },
    elegante: {
      name: 'Elegante',
      ...
      guideImage: 'https://res.cloudinary.com/dqljyf76t/image/upload/v1745071344/GUIA_ELEGANTE_jkl012.webp'
    },
    criativo: {
      name: 'Criativo',
      ...
      guideImage: 'https://res.cloudinary.com/dqljyf76t/image/upload/v1745071344/GUIA_CRIATIVO_mno345.webp'
    },
    contemporaneo: {
      name: 'Contemporâneo',
      ...
      guideImage: 'https://res.cloudinary.com/dqljyf76t/image/upload/v1745071344/GUIA_CONTEMPORANEO_pqr678.webp'
    }
  }
};
...
function generateAllSteps() {
  ...
  step19.blocks[2].properties.text = 'Estamos calculando seu estilo predominante e preparando seu resultado personalizado.';
  ...
  const funnelConfig = {
    ...
    conversion: {
      offerPrice: {
        ...
        oneTime: { value: 39.90, discount: 0.1 }
      },
      guaranteeDays: 7,
      bonusItems: [
...
function updateEditorIntegration() {
  ...
  const stagesPanelPath = path.join(__dirname, 'src/components/editor/funnel/FunnelStagesPanel.tsx');
...
function generateSummary() {
  ...
  const components = [
    'quiz-intro-header', 'heading-inline', 'text-inline',
    'decorative-bar-inline', 'form-input', 'button-inline',
    'options-grid', 'quiz-progress', 'quiz-results',
    'style-results', 'final-step', 'image-display-inline',
    'legal-notice-inline'
  ];
