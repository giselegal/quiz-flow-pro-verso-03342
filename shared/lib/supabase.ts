...
const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || "https://txqljpitotmcxntprxiu.supabase.co";
const SUPABASE_ANON_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR4cWxqcGl0b3RtY3hudHByeGl1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDk4NjI3MzQsImV4cCI6MjA2NTQzODczNH0.rHGZV47KUnSJ0fDNXbL-OjuB50BsuzT2IeO_LL-P8ok";
...
export const supabaseAdmin: SupabaseClient<Database> | null = (() => {
  ...
  if (!serviceKey) {
    console.warn('VITE_SUPABASE_SERVICE_KEY não encontrada. Operações administrativas não estarão disponíveis.');
    return null;
  }
